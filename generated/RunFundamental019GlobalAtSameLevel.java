...
public class RunFundamental019GlobalAtSameLevel extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFundamental019GlobalAtSameLevel");
            CobolProgram.registerCallAlias("prog2", "RunFundamental019GlobalAtSameLevel_Prog2");
            CobolProgram.registerCallAlias("prog3", "RunFundamental019GlobalAtSameLevel_Prog3");
            CobolProgram.registerCallAlias("prog", "RunFundamental019GlobalAtSameLevel");
    ...
    public static void main(String[] args) {
        ...
        new RunFundamental019GlobalAtSameLevel().run();
    }
}

class RunFundamental019GlobalAtSameLevel_Prog2 extends CobolProgram {
    ...
    public static void main(String[] args) {
        ...
        CobolIntrinsics.setCommandLineArgs(args);
        new RunFundamental019GlobalAtSameLevel_Prog2().run();
    }
}

class RunFundamental019GlobalAtSameLevel_Prog3 extends CobolProgram {
    ...
    private CobolString x = RunFundamental019GlobalAtSameLevel.x; // GLOBAL from RunFundamental019GlobalAtSameLevel
    private void para_main() {
        CobolDisplay.display(String.valueOf(x));
        return;
    }
    ...
    public void run() {
        ...
        try {
            ...
            x = CobolProgram.resolveInheritedGlobal("X", RunFundamental019GlobalAtSameLevel.x);
            para_main();
        } finally { CobolProgram.popActive(); }
    }
    public static void main(String[] args) {
        ...
        CobolIntrinsics.setCommandLineArgs(args);
        new RunFundamental019GlobalAtSameLevel_Prog3().run();
    }
}
