...
public class RunMisc044TransformStatement extends CobolProgram {
    ...
    private void para_main() {
        ...
        { String _tf = String.valueOf(x); String _from = String.valueOf(CobolIntrinsics.alphabetAscii()); String _to = String.valueOf(CobolIntrinsics.alphabetEbcdic()); StringBuilder _sb = new StringBuilder(_tf); for (int _i = 0; _i < _sb.length(); _i++) { int _p = _from.indexOf(_sb.charAt(_i)); if (_p >= 0 && _p < _to.length()) _sb.setCharAt(_i, _to.charAt(_p)); } x.set(_sb.toString()); }
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunMisc044TransformStatement");
            CobolProgram.registerCallAlias("prog", "RunMisc044TransformStatement");
