...
public class RunMisc016MoveWithRefmodVariable extends CobolProgram {
    ...
    private CobolString x = new CobolString(4, "1234");
    private CobolString y = new CobolString(4, "abcd");
    private int i = 1;
    ...
    @SuppressWarnings("unused") private final com.lazarus.cobol.vmg.FieldDescriptor _vmgfd_i = com.lazarus.cobol.vmg.FieldDescriptor.builder().grid(_vmg_grid).at(8, 1).storage(com.lazarus.cobol.vmg.FieldDescriptor.Storage.NUMERIC_DISPLAY).name("I").picDigits(1).build();


    private void para_main() {
        y.set(String.valueOf(CobolString.refMod(x, 1, i)));
        if (!CobolString.cobolEquals(String.valueOf(y), String.valueOf("1   "))) {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunMisc016MoveWithRefmodVariable");
            CobolProgram.registerCallAlias("prog", "RunMisc016MoveWithRefmodVariable");
    ...
    public static void main(String[] args) {
        ...
        new RunMisc016MoveWithRefmodVariable().run();
    }
}
