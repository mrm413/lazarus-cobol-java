...
public class RunFunctions002FunctionAnnuity extends CobolProgram {
    ...
    private void para_main() {
        z = CobolIntrinsics.truncateToField(CobolIntrinsics.toBigDecimal(CobolIntrinsics.annuity(3, 5)), 36, 35, true);
        if (z.compareTo(new BigDecimal("3.00293255131964809384164222873900293")) != 0) {
            CobolDisplay.display(CobolDisplay.formatPic(z, 36, 35, true, "LEADING"));
        }
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFunctions002FunctionAnnuity");
            CobolProgram.registerCallAlias("prog", "RunFunctions002FunctionAnnuity");
