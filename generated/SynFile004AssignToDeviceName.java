...
public class SynFile004AssignToDeviceName extends CobolProgram {
    ...
    // FILE DESCRIPTORS
    private CobolFile test_file = new CobolFile("ORGANIZATION", "SEQUENTIAL", "SEQUENTIAL", "TEST-FILE");
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "SynFile004AssignToDeviceName");
            CobolProgram.registerCallAlias("prog", "SynFile004AssignToDeviceName");
    ...
    public static void main(String[] args) {
        ...
        new SynFile004AssignToDeviceName().run();
    }
}
