...
public class SynMisc003WarnLiteralSizeInConstantExprLevel88 extends CobolProgram {
    ...
    @SuppressWarnings("unused") private final com.lazarus.cobol.vmg.FieldDescriptor _vmgfd_xx = com.lazarus.cobol.vmg.FieldDescriptor.builder().grid(_vmg_grid).at(2, 1).storage(com.lazarus.cobol.vmg.FieldDescriptor.Storage.ALPHANUMERIC).name("xx").build();
    ...
    private void para_main() {
        ...
        if ((CobolString.cobolEquals(String.valueOf(xx), "00") || CobolString.cobolEquals(String.valueOf(xx), "a") || CobolString.cobolEquals(String.valueOf(xx), "b") || CobolString.cobolEquals(String.valueOf(xx), "cd"))) {
            xx.set("a");
            xx.set("00");
        }
        x = 99;
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "SynMisc003WarnLiteralSizeInConstantExprLevel88");
            CobolProgram.registerCallAlias("prog", "SynMisc003WarnLiteralSizeInConstantExprLevel88");
