...
public class RunFunctions099FunctionSum extends CobolProgram {
    ...
    private void para_main() {
        z = (int) CobolIntrinsics.toBigDecimal(CobolIntrinsics.sum(3, -14, 0, 8, -3)).intValue();
        if (z != -6) {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFunctions099FunctionSum");
            CobolProgram.registerCallAlias("prog", "RunFunctions099FunctionSum");
    ...
    public static void main(String[] args) {
        ...
        new RunFunctions099FunctionSum().run();
    }
}
