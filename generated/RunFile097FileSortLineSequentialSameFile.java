...
public class RunFile097FileSortLineSequentialSameFile extends CobolProgram {
    ...
    private CobolFile sort_wrk = new CobolFile("dummy", "SEQUENTIAL", "SEQUENTIAL", "SORT-WRK");
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFile097FileSortLineSequentialSameFile");
            CobolProgram.registerCallAlias("prog", "RunFile097FileSortLineSequentialSameFile");
