...
public class RunMisc014MoveToItself extends CobolProgram {
    ...
    private void para_main() {
        x = (int) Math.abs(CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(x), 2));
        if (x != 12) {
            CobolDisplay.display(CobolDisplay.formatPic(x, 2, 0, false));
        }
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunMisc014MoveToItself");
            CobolProgram.registerCallAlias("prog", "RunMisc014MoveToItself");
    ...
    public static void main(String[] args) {
        ...
        new RunMisc014MoveToItself().run();
    }
}
