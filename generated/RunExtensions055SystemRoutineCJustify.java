...
public class RunExtensions055SystemRoutineCJustify extends CobolProgram {
    ...
    private CobolString x = new CobolString(4, " OK ");
    ...
    private void para_main() {
        CobolProgram.call("C$JUSTIFY", x, "L");
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunExtensions055SystemRoutineCJustify");
            CobolProgram.registerCallAlias("prog", "RunExtensions055SystemRoutineCJustify");
    ...
    public static void main(String[] args) {
        ...
        new RunExtensions055SystemRoutineCJustify().run();
    }
}
