...
public class SynFile036UndeclaredAssignVariable extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "SynFile036UndeclaredAssignVariable");
            CobolProgram.registerCallAlias("prog2", "SynFile036UndeclaredAssignVariable_Prog2");
            CobolProgram.registerCallAlias("prog3", "SynFile036UndeclaredAssignVariable_Prog3");
            CobolProgram.registerCallAlias("prog", "SynFile036UndeclaredAssignVariable");
    ...
    public static void main(String[] args) {
        ...
        new SynFile036UndeclaredAssignVariable().run();
    }
}

class SynFile036UndeclaredAssignVariable_Prog2 extends CobolProgram {
    ...
    private static final String glob_path2 = SynFile036UndeclaredAssignVariable.glob_path2; // GLOBAL from SynFile036UndeclaredAssignVariable
    private static final String glob_var2 = SynFile036UndeclaredAssignVariable.glob_var2; // GLOBAL from SynFile036UndeclaredAssignVariable
    private void para_main() {
    ...
    public static void main(String[] args) {
        ...
        CobolIntrinsics.setCommandLineArgs(args);
        new SynFile036UndeclaredAssignVariable_Prog2().run();
    }
}

class SynFile036UndeclaredAssignVariable_Prog3 extends CobolProgram {
    ...
    private void para_main() {
        ...
        if (!CobolString.cobolEquals(String.valueOf(glob_path), String.valueOf("                                                                                                                                                                                                                                                                "))) {
            CobolDisplay.display(String.valueOf(glob_path));
        }
        return;
    }
    @Override
    ...
    public static void main(String[] args) {
        ...
        CobolIntrinsics.setCommandLineArgs(args);
        new SynFile036UndeclaredAssignVariable_Prog3().run();
    }
}
