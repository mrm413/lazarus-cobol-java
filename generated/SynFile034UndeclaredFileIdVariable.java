...
public class SynFile034UndeclaredFileIdVariable extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "SynFile034UndeclaredFileIdVariable");
            CobolProgram.registerCallAlias("prog", "SynFile034UndeclaredFileIdVariable");
    ...
    public static void main(String[] args) {
        ...
        new SynFile034UndeclaredFileIdVariable().run();
    }
}
