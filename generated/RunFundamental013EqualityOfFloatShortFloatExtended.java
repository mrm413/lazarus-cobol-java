...
public class RunFundamental013EqualityOfFloatShortFloatExtended extends CobolProgram {
    ...
    @SuppressWarnings("unused") private final com.lazarus.cobol.vmg.FieldDescriptor _vmgfd_src1 = com.lazarus.cobol.vmg.FieldDescriptor.builder().grid(_vmg_grid).at(0, 1).storage(com.lazarus.cobol.vmg.FieldDescriptor.Storage.ALPHANUMERIC).name("SRC1").build();
    ...
    @SuppressWarnings("unused") private final com.lazarus.cobol.vmg.FieldDescriptor _vmgfd_dst2 = com.lazarus.cobol.vmg.FieldDescriptor.builder().grid(_vmg_grid).at(3, 1).storage(com.lazarus.cobol.vmg.FieldDescriptor.Storage.ALPHANUMERIC).name("DST2").build();
    ...
    private void para_main() {
        ...
        if (CobolIntrinsics.toBigDecimal(dst1).compareTo(new BigDecimal("11.55")) != 0) {
            CobolDisplay.display("error 1: move/compare FLOAT-EXTENDED to FLOAT-SHORT failed " + CobolDisplay.formatFloatShort(dst1));
        }
        dst2 = Double.parseDouble(String.valueOf(src1).trim());
        if (CobolIntrinsics.toBigDecimal(dst1).compareTo(new BigDecimal("11.55")) != 0) {
            CobolDisplay.display("error 2: move/compare FLOAT-EXTENDED to FLOAT-SHORT failed " + CobolDisplay.formatFloatLong(dst2));
        }
        ...
        if (CobolIntrinsics.toBigDecimal(dst1).compareTo(new BigDecimal("11.55")) != 0) {
            CobolDisplay.display("error 3: move/compare FLOAT-EXTENDED to FLOAT-SHORT failed " + CobolDisplay.formatFloatShort(dst1));
        }
        dst2 = Double.parseDouble(String.valueOf(src2).trim());
        if (CobolIntrinsics.toBigDecimal(dst2).compareTo(new BigDecimal("11.55")) != 0) {
            CobolDisplay.display("error 4: move/compare FLOAT-EXTENDED to FLOAT-SHT failed " + CobolDisplay.formatFloatLong(dst2));
        }
        dst1 = (float) Double.parseDouble(String.valueOf(0).trim());
        ...
        dst1 = (float) Double.parseDouble(String.valueOf(new BigDecimal("1.1234567")).trim());
        dst2 = Double.parseDouble(String.valueOf(new BigDecimal("0.1234568")).trim());
        dst2 = Double.parseDouble(String.valueOf(CobolIntrinsics.toBigDecimal(dst2).add(CobolIntrinsics.toBigDecimal(1))).trim());
        if (!(CobolIntrinsics.floatEqUlp1((float)(dst1), (float)(dst2)))) {
            CobolDisplay.display("move/compare of very near numbers failed (not identical after ADD): " + CobolDisplay.formatFloatShort(dst1) + " - " + CobolDisplay.formatFloatLong(dst2));
        }
        dst1 = (float) Double.parseDouble(String.valueOf(new BigDecimal("1.1234567")).trim());
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFundamental013EqualityOfFloatShortFloatExtended");
            CobolProgram.registerCallAlias("prog", "RunFundamental013EqualityOfFloatShortFloatExtended");
