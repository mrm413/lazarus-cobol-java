...
public class RunReportwriter001ReportColPlus extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunReportwriter001ReportColPlus");
            CobolProgram.registerCallAlias("prog", "RunReportwriter001ReportColPlus");
    ...
    public static void main(String[] args) {
        ...
        new RunReportwriter001ReportColPlus().run();
    }
}
