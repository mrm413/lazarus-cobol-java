...
public class RunFile045LineSequentialWriteAfter extends CobolProgram {
    ...
    // FILE DESCRIPTORS
    private CobolFile test_file = new CobolFile("./TEST-FILE", "LINE SEQUENTIAL", "SEQUENTIAL", "TEST-FILE");
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFile045LineSequentialWriteAfter");
            CobolProgram.registerCallAlias("prog", "RunFile045LineSequentialWriteAfter");
    ...
    public static void main(String[] args) {
        ...
        new RunFile045LineSequentialWriteAfter().run();
    }
}
