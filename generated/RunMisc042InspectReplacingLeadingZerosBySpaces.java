...
public class RunMisc042InspectReplacingLeadingZerosBySpaces extends CobolProgram {
    ...
    private CobolString x = new CobolString(4, "0001");
    ...
    private void para_main() {
        x.set(CobolIntrinsics.inspectReplaceLeading(String.valueOf(x), "0", " "));
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunMisc042InspectReplacingLeadingZerosBySpaces");
            CobolProgram.registerCallAlias("prog", "RunMisc042InspectReplacingLeadingZerosBySpaces");
    ...
    public static void main(String[] args) {
        ...
        new RunMisc042InspectReplacingLeadingZerosBySpaces().run();
    }
}
