...
public class RunRefmod000StaticReferenceModification extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunRefmod000StaticReferenceModification");
            CobolProgram.registerCallAlias("prog", "RunRefmod000StaticReferenceModification");
    ...
    public static void main(String[] args) {
        ...
        new RunRefmod000StaticReferenceModification().run();
    }
}
