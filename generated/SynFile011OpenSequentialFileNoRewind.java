...
public class SynFile011OpenSequentialFileNoRewind extends CobolProgram {
    ...
    private CobolFile rewind = new CobolFile("REWIND", "SEQUENTIAL", "SEQUENTIAL", "REWIND");
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "SynFile011OpenSequentialFileNoRewind");
            CobolProgram.registerCallAlias("prog", "SynFile011OpenSequentialFileNoRewind");
    ...
    public static void main(String[] args) {
        ...
        new SynFile011OpenSequentialFileNoRewind().run();
    }
}
