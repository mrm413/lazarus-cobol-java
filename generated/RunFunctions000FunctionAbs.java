...
public class RunFunctions000FunctionAbs extends CobolProgram {
    ...
    private BigDecimal x = new BigDecimal("-1.2345");
    ...
    private void para_main() {
        CobolDisplay.displayNoAdvancing(CobolDisplay.formatPic(CobolIntrinsics.abs(x), 8, 4, true, "LEADING"));
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFunctions000FunctionAbs");
            CobolProgram.registerCallAlias("prog", "RunFunctions000FunctionAbs");
    ...
    public static void main(String[] args) {
        ...
        new RunFunctions000FunctionAbs().run();
    }
}
