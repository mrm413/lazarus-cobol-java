...
public class RunFundamental028ContainedProgramVisibility2 extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFundamental028ContainedProgramVisibility2");
            CobolProgram.registerCallAlias("prog2", "RunFundamental028ContainedProgramVisibility2_Prog2");
            CobolProgram.registerCallAlias("prog3", "RunFundamental028ContainedProgramVisibility2_Prog3");
            CobolProgram.registerCallAlias("prog", "RunFundamental028ContainedProgramVisibility2");
    ...
    public static void main(String[] args) {
        ...
        new RunFundamental028ContainedProgramVisibility2().run();
    }
}

class RunFundamental028ContainedProgramVisibility2_Prog2 extends CobolProgram {
    ...
    public static void main(String[] args) {
        ...
        CobolIntrinsics.setCommandLineArgs(args);
        new RunFundamental028ContainedProgramVisibility2_Prog2().run();
    }
}

class RunFundamental028ContainedProgramVisibility2_Prog3 extends CobolProgram {
    ...
    private CobolString x = RunFundamental028ContainedProgramVisibility2.x; // GLOBAL from RunFundamental028ContainedProgramVisibility2
    private void para_main() {
        if (!CobolString.cobolEquals(String.valueOf(x), String.valueOf("prog2"))) {
            CobolDisplay.display(String.valueOf(x));
        }
    ...
    public void run() {
        ...
        try {
            ...
            x = CobolProgram.resolveInheritedGlobal("X", RunFundamental028ContainedProgramVisibility2.x);
            para_main();
        } finally { CobolProgram.popActive(); }
    }
    public static void main(String[] args) {
        ...
        CobolIntrinsics.setCommandLineArgs(args);
        new RunFundamental028ContainedProgramVisibility2_Prog3().run();
    }
}
