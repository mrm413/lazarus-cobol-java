...
public class SynRedefines000RedefinesNotFollowingEntryName extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "SynRedefines000RedefinesNotFollowingEntryName");
            CobolProgram.registerCallAlias("prog", "SynRedefines000RedefinesNotFollowingEntryName");
    ...
    public static void main(String[] args) {
        ...
        new SynRedefines000RedefinesNotFollowingEntryName().run();
    }
}
