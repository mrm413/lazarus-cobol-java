...
public class SynFile014VariableRecordLength extends CobolProgram {
    ...
    private CobolString test_rec = new CobolString(144); // Group: TEST-REC
    ...
    // FILE DESCRIPTORS
    private CobolFile test_file = new CobolFile("FILE-TEST", "SEQUENTIAL", "SEQUENTIAL", "TEST-FILE");
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "SynFile014VariableRecordLength");
            CobolProgram.registerCallAlias("prog", "SynFile014VariableRecordLength");
    ...
    public static void main(String[] args) {
        ...
        new SynFile014VariableRecordLength().run();
    }
}
