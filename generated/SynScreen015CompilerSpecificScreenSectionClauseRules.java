...
public class SynScreen015CompilerSpecificScreenSectionClauseRules extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "SynScreen015CompilerSpecificScreenSectionClauseRules");
            CobolProgram.registerCallAlias("prog", "SynScreen015CompilerSpecificScreenSectionClauseRules");
    ...
    public static void main(String[] args) {
        ...
        new SynScreen015CompilerSpecificScreenSectionClauseRules().run();
    }
}
