...
public class RunFundamental057RoundedTruncation extends CobolProgram {
    ...
    private void para_main() {
        ...
        m = (int) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(new BigDecimal("2.49")).setScale(0, RoundingMode.DOWN), 1);
        { BigDecimal _cv = CobolIntrinsics.toBigDecimal(new BigDecimal("-2.49")).setScale(0, RoundingMode.DOWN).abs(); if (_cv.compareTo(new BigDecimal("10")) >= 0) { CobolIntrinsics.setException("EC-SIZE-OVERFLOW"); } }
        n = (int) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(new BigDecimal("-2.49")).setScale(0, RoundingMode.DOWN), 1);
        ...
        o = (int) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(new BigDecimal("2.50")).setScale(0, RoundingMode.DOWN), 1);
        { BigDecimal _cv = CobolIntrinsics.toBigDecimal(new BigDecimal("-2.50")).setScale(0, RoundingMode.DOWN).abs(); if (_cv.compareTo(new BigDecimal("10")) >= 0) { CobolIntrinsics.setException("EC-SIZE-OVERFLOW"); } }
        p = (int) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(new BigDecimal("-2.50")).setScale(0, RoundingMode.DOWN), 1);
        ...
        q = (int) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(new BigDecimal("3.49")).setScale(0, RoundingMode.DOWN), 1);
        { BigDecimal _cv = CobolIntrinsics.toBigDecimal(new BigDecimal("-3.49")).setScale(0, RoundingMode.DOWN).abs(); if (_cv.compareTo(new BigDecimal("10")) >= 0) { CobolIntrinsics.setException("EC-SIZE-OVERFLOW"); } }
        r = (int) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(new BigDecimal("-3.49")).setScale(0, RoundingMode.DOWN), 1);
        ...
        s = (int) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(new BigDecimal("3.50")).setScale(0, RoundingMode.DOWN), 1);
        { BigDecimal _cv = CobolIntrinsics.toBigDecimal(new BigDecimal("-3.50")).setScale(0, RoundingMode.DOWN).abs(); if (_cv.compareTo(new BigDecimal("10")) >= 0) { CobolIntrinsics.setException("EC-SIZE-OVERFLOW"); } }
        t = (int) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(new BigDecimal("-3.50")).setScale(0, RoundingMode.DOWN), 1);
        ...
        u = (int) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(new BigDecimal("3.510")).setScale(0, RoundingMode.DOWN), 1);
        { BigDecimal _cv = CobolIntrinsics.toBigDecimal(new BigDecimal("-3.510")).setScale(0, RoundingMode.DOWN).abs(); if (_cv.compareTo(new BigDecimal("10")) >= 0) { CobolIntrinsics.setException("EC-SIZE-OVERFLOW"); } }
        v = (int) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(new BigDecimal("-3.510")).setScale(0, RoundingMode.DOWN), 1);
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFundamental057RoundedTruncation");
            CobolProgram.registerCallAlias("prog", "RunFundamental057RoundedTruncation");
    ...
    public static void main(String[] args) {
        ...
        new RunFundamental057RoundedTruncation().run();
    }
}
