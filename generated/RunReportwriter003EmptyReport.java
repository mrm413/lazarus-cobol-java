...
public class RunReportwriter003EmptyReport extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunReportwriter003EmptyReport");
            CobolProgram.registerCallAlias("prog", "RunReportwriter003EmptyReport");
    ...
    public static void main(String[] args) {
        ...
        new RunReportwriter003EmptyReport().run();
    }
}
