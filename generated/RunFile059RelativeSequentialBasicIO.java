...
public class RunFile059RelativeSequentialBasicIO extends CobolProgram {
    ...
    // FILE DESCRIPTORS
    private CobolFile file1 = new CobolFile("ORGANIZATION", "RELATIVE", "SEQUENTIAL", "FILE1");
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFile059RelativeSequentialBasicIO");
            CobolProgram.registerCallAlias("prog", "RunFile059RelativeSequentialBasicIO");
    ...
    public static void main(String[] args) {
        ...
        new RunFile059RelativeSequentialBasicIO().run();
    }
}
