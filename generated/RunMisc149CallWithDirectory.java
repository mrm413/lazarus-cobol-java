...
public class RunMisc149CallWithDirectory extends CobolProgram {
    ...
    private CobolString myrtn = new CobolString(9, "DIR/SUB");
    ...
    private void para_main() {
        try {
            CobolProgram.callOrThrow("SUB", "0");
        ...
        CobolProgram.cancel("SUB");
        try {
            CobolProgram.callOrThrow("SUB", "0");
        } catch (Exception _callEx1) {
            /* CONTINUE */
        }
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunMisc149CallWithDirectory");
            CobolProgram.registerCallAlias("prog", "RunMisc149CallWithDirectory");
    ...
    public static void main(String[] args) {
        ...
        new RunMisc149CallWithDirectory().run();
    }
}
