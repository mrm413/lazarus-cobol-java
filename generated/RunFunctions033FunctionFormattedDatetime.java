...
public class RunFunctions033FunctionFormattedDatetime extends CobolProgram {
    ...
    @SuppressWarnings("unused") private final com.lazarus.cobol.vmg.FieldDescriptor _vmgfd_str = com.lazarus.cobol.vmg.FieldDescriptor.builder().grid(_vmg_grid).at(0, 40).storage(com.lazarus.cobol.vmg.FieldDescriptor.Storage.ALPHANUMERIC).name("str").build();


    private void para_main() {
        str.set(String.valueOf(CobolIntrinsics.formatted_datetime("YYYYMMDDThhmmss", 1, 45296)));
        if (!CobolString.cobolEquals(String.valueOf(str), String.valueOf("16010101T123456"))) {
        ...
        if (!CobolString.cobolEquals(String.valueOf(str), String.valueOf("1601-01-01T12:34:56"))) {
        ...
        if (!CobolString.cobolEquals(String.valueOf(str), String.valueOf("1601001T123456-1234"))) {
        ...
        if (!CobolString.cobolEquals(String.valueOf(str), String.valueOf("1601001T123456+0000"))) {
        ...
        if (!CobolString.cobolEquals(String.valueOf(str), String.valueOf("2013365T235900.000000000Z"))) {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFunctions033FunctionFormattedDatetime");
            CobolProgram.registerCallAlias("prog", "RunFunctions033FunctionFormattedDatetime");
    ...
    public static void main(String[] args) {
        ...
        new RunFunctions033FunctionFormattedDatetime().run();
    }
}
