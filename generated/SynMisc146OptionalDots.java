...
public class SynMisc146OptionalDots extends CobolProgram {
    ...
    private void p() {
        CobolIntrinsics.setCurrentLocation("prog; P OF MAIN");
        return;
    }
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "SynMisc146OptionalDots");
            CobolProgram.registerCallAlias("prog", "SynMisc146OptionalDots");
    ...
    public static void main(String[] args) {
        ...
        new SynMisc146OptionalDots().run();
    }
}
