...
public class RunExtensions060SystemRoutineCTolower extends CobolProgram {
    ...
    private void para_main() {
        CobolProgram.call("C$TOLOWER", x, 2);
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunExtensions060SystemRoutineCTolower");
            CobolProgram.registerCallAlias("prog", "RunExtensions060SystemRoutineCTolower");
    ...
    public static void main(String[] args) {
        ...
        new RunExtensions060SystemRoutineCTolower().run();
    }
}
