...
public class RunSubscripts004SubscriptBoundsWithOccursDependingOn3 extends CobolProgram {
    ...
    private void para_main() {
        if ((n >= 5 && !CobolString.cobolEquals(String.valueOf(x[5 - 1]), String.valueOf(" ")))) {
            CobolDisplay.display("1-" + String.valueOf(x[5 - 1]));
        } else if ((n >= 5) || (!CobolString.cobolEquals(String.valueOf(x[5 - 1]), String.valueOf(" ")))) {
            CobolDisplay.display("2-" + String.valueOf(x[5 - 1]));
        }
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunSubscripts004SubscriptBoundsWithOccursDependingOn3");
            CobolProgram.registerCallAlias("prog", "RunSubscripts004SubscriptBoundsWithOccursDependingOn3");
    ...
    public static void main(String[] args) {
        ...
        new RunSubscripts004SubscriptBoundsWithOccursDependingOn3().run();
    }
}
