...
public class RunReportwriter002ReportOverlappingFields extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunReportwriter002ReportOverlappingFields");
            CobolProgram.registerCallAlias("prog", "RunReportwriter002ReportOverlappingFields");
    ...
    public static void main(String[] args) {
        ...
        new RunReportwriter002ReportOverlappingFields().run();
    }
}
