...
public class SynRefmod000ValidReferenceModification extends CobolProgram {
    ...
    @SuppressWarnings("unused") private final com.lazarus.cobol.vmg.FieldDescriptor _vmgfd_cb_var = com.lazarus.cobol.vmg.FieldDescriptor.builder().grid(_vmg_grid).at(4, 1).storage(com.lazarus.cobol.vmg.FieldDescriptor.Storage.NUMERIC_DISPLAY).name("VAR").picDigits(1).build();
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "SynRefmod000ValidReferenceModification");
            CobolProgram.registerCallAlias("prog", "SynRefmod000ValidReferenceModification");
