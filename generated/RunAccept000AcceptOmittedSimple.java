...
public class RunAccept000AcceptOmittedSimple extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunAccept000AcceptOmittedSimple");
            CobolProgram.registerCallAlias("prog", "RunAccept000AcceptOmittedSimple");
    ...
    public static void main(String[] args) {
        ...
        new RunAccept000AcceptOmittedSimple().run();
    }
}
