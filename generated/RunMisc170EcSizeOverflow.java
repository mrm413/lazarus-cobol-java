...
public class RunMisc170EcSizeOverflow extends CobolProgram {
    ...
    private void para_main() {
        ...
        y = (int) Math.abs(CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(CobolIntrinsics.toBigDecimal(x).divide(new BigDecimal("0.1"), 18, RoundingMode.HALF_UP)), 1));
        if (!CobolString.cobolEquals(String.valueOf(CobolIntrinsics.trim(CobolIntrinsics.exception_status())), String.valueOf("EC-SIZE-OVERFLOW"))) {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunMisc170EcSizeOverflow");
            CobolProgram.registerCallAlias("prog", "RunMisc170EcSizeOverflow");
