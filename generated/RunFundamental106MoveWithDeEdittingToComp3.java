...
public class RunFundamental106MoveWithDeEdittingToComp3 extends CobolProgram {
    public static final String COBOL_PROGRAM_ID = "MoveDeEditing_4";
    ...
    @SuppressWarnings("unused") private final com.lazarus.cobol.vmg.FieldDescriptor _vmgfd_disp_1 = com.lazarus.cobol.vmg.FieldDescriptor.builder().grid(_vmg_grid).at(10, 4).storage(com.lazarus.cobol.vmg.FieldDescriptor.Storage.PACKED_BCD).name("DISP-1").picDigits(6).picScale(2).signed(true).build();
    ...
    @SuppressWarnings("unused") private final com.lazarus.cobol.vmg.FieldDescriptor _vmgfd_disp_2 = com.lazarus.cobol.vmg.FieldDescriptor.builder().grid(_vmg_grid).at(27, 5).storage(com.lazarus.cobol.vmg.FieldDescriptor.Storage.PACKED_BCD).name("DISP-2").picDigits(8).picScale(1).signed(true).build();
    ...
    @Override
    public void run() {
        CobolIntrinsics.setModuleInfo("MoveDeEditing_4", "", "MoveDeEditing_4.cob");
        CobolProgram.pushActive("MoveDeEditing_4");
        try {
            CobolProgram.registerCallAlias("MoveDeEditing_4", "RunFundamental106MoveWithDeEdittingToComp3");
            CobolProgram.registerCallAlias("movedeediting_4", "RunFundamental106MoveWithDeEdittingToComp3");
    ...
    public static void main(String[] args) {
        ...
        new RunFundamental106MoveWithDeEdittingToComp3().run();
    }
}
