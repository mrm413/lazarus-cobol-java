...
public class RunFunctions117FunctionYearToYyyy extends CobolProgram {
    ...
    private void para_main() {
        z = (int) CobolIntrinsics.toBigDecimal(CobolIntrinsics.year_to_yyyy(50)).intValue();
        if (z != 2050) {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFunctions117FunctionYearToYyyy");
            CobolProgram.registerCallAlias("prog", "RunFunctions117FunctionYearToYyyy");
    ...
    public static void main(String[] args) {
        ...
        new RunFunctions117FunctionYearToYyyy().run();
    }
}
