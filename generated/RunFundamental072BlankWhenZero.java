...
public class RunFundamental072BlankWhenZero extends CobolProgram {
    ...
    private CobolString x = new CobolString(1, "1");
    ...
    private void para_main() {
        ...
        x.set(CobolDisplay.blankWhenZero(CobolDisplay.formatEdited(0, "9"), 1));
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFundamental072BlankWhenZero");
            CobolProgram.registerCallAlias("prog", "RunFundamental072BlankWhenZero");
    ...
    public static void main(String[] args) {
        ...
        new RunFundamental072BlankWhenZero().run();
    }
}
