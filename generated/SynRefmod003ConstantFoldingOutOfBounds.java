...
public class SynRefmod003ConstantFoldingOutOfBounds extends CobolProgram {
    ...
    private void para_main() {
        if (var_len < 4) {
            ...
            x.set(CobolIntrinsics.inspectConverting(String.valueOf(x), "DEF", String.valueOf(CobolString.refMod(x, 1, (0 + var_len)))));
        }
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "SynRefmod003ConstantFoldingOutOfBounds");
            CobolProgram.registerCallAlias("prog", "SynRefmod003ConstantFoldingOutOfBounds");
    ...
    public static void main(String[] args) {
        ...
        new SynRefmod003ConstantFoldingOutOfBounds().run();
    }
}
