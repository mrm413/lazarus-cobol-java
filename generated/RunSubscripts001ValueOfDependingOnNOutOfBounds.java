...
public class RunSubscripts001ValueOfDependingOnNOutOfBounds extends CobolProgram {
    ...
    private void para_main() {
        n = (int) Math.abs(CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(5), 1));
        ...
        n = (int) Math.abs(CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(3), 1));
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunSubscripts001ValueOfDependingOnNOutOfBounds");
            CobolProgram.registerCallAlias("prog", "RunSubscripts001ValueOfDependingOnNOutOfBounds");
    ...
    public static void main(String[] args) {
        ...
        new RunSubscripts001ValueOfDependingOnNOutOfBounds().run();
    }
}
