...
public class RunFile051SequentialFileIOWithVariableRecords extends CobolProgram {
    ...
    // FILE DESCRIPTORS
    private CobolFile f = new CobolFile("F", "SEQUENTIAL", "SEQUENTIAL", "F", 10, 20);
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFile051SequentialFileIOWithVariableRecords");
            CobolProgram.registerCallAlias("prog", "RunFile051SequentialFileIOWithVariableRecords");
    ...
    public static void main(String[] args) {
        ...
        new RunFile051SequentialFileIOWithVariableRecords().run();
    }
}
