...
public class SynFile010OpenSequentialFileReversed extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "SynFile010OpenSequentialFileReversed");
            CobolProgram.registerCallAlias("prog", "SynFile010OpenSequentialFileReversed");
    ...
    public static void main(String[] args) {
        ...
        new SynFile010OpenSequentialFileReversed().run();
    }
}
