...
public class RunReportwriter021DuplicateInitiate extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunReportwriter021DuplicateInitiate");
            CobolProgram.registerCallAlias("prog", "RunReportwriter021DuplicateInitiate");
    ...
    public static void main(String[] args) {
        ...
        new RunReportwriter021DuplicateInitiate().run();
    }
}
