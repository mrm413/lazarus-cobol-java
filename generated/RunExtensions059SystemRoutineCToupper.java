...
public class RunExtensions059SystemRoutineCToupper extends CobolProgram {
    ...
    private void para_main() {
        CobolProgram.call("C$TOUPPER", x, 2);
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunExtensions059SystemRoutineCToupper");
            CobolProgram.registerCallAlias("prog", "RunExtensions059SystemRoutineCToupper");
    ...
    public static void main(String[] args) {
        ...
        new RunExtensions059SystemRoutineCToupper().run();
    }
}
