...
public class SynScreen011RedundantScreenClauses extends CobolProgram {
    ...
    private void para_main() {
        ...
        x = (int) Math.abs(CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(CobolDisplay.accept()), 3));
    }
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "SynScreen011RedundantScreenClauses");
            CobolProgram.registerCallAlias("prog", "SynScreen011RedundantScreenClauses");
    ...
    public static void main(String[] args) {
        ...
        new SynScreen011RedundantScreenClauses().run();
    }
}
