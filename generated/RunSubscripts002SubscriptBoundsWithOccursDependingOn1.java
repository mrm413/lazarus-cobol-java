...
public class RunSubscripts002SubscriptBoundsWithOccursDependingOn1 extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunSubscripts002SubscriptBoundsWithOccursDependingOn1");
            CobolProgram.registerCallAlias("prog", "RunSubscripts002SubscriptBoundsWithOccursDependingOn1");
    ...
    public static void main(String[] args) {
        ...
        new RunSubscripts002SubscriptBoundsWithOccursDependingOn1().run();
    }
}
