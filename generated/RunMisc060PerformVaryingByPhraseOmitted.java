...
public class RunMisc060PerformVaryingByPhraseOmitted extends CobolProgram {
    ...
    private void para_main() {
        ...
        if (x != 7) {
            CobolDisplay.display("WRONG X: " + CobolDisplay.formatPic(x, 1, 0, false));
        }
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunMisc060PerformVaryingByPhraseOmitted");
            CobolProgram.registerCallAlias("prog", "RunMisc060PerformVaryingByPhraseOmitted");
    ...
    public static void main(String[] args) {
        ...
        new RunMisc060PerformVaryingByPhraseOmitted().run();
    }
}
