...
public class RunFundamental105MoveWithDeEdittingToBinary extends CobolProgram {
    public static final String COBOL_PROGRAM_ID = "MoveDeEditing_3";
    ...
    @Override
    public void run() {
        CobolIntrinsics.setModuleInfo("MoveDeEditing_3", "", "MoveDeEditing_3.cob");
        CobolProgram.pushActive("MoveDeEditing_3");
        try {
            CobolProgram.registerCallAlias("MoveDeEditing_3", "RunFundamental105MoveWithDeEdittingToBinary");
            CobolProgram.registerCallAlias("movedeediting_3", "RunFundamental105MoveWithDeEdittingToBinary");
    ...
    public static void main(String[] args) {
        ...
        new RunFundamental105MoveWithDeEdittingToBinary().run();
    }
}
