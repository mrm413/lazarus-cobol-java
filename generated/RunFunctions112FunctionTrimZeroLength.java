...
public class RunFunctions112FunctionTrimZeroLength extends CobolProgram {
    ...
    private CobolString x = new CobolString(4, "NOOK");
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFunctions112FunctionTrimZeroLength");
            CobolProgram.registerCallAlias("prog", "RunFunctions112FunctionTrimZeroLength");
    ...
    public static void main(String[] args) {
        ...
        new RunFunctions112FunctionTrimZeroLength().run();
    }
}
