...
public class RunReportwriter023MissingInitiateAndTerminate extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunReportwriter023MissingInitiateAndTerminate");
            CobolProgram.registerCallAlias("prog", "RunReportwriter023MissingInitiateAndTerminate");
    ...
    public static void main(String[] args) {
        ...
        new RunReportwriter023MissingInitiateAndTerminate().run();
    }
}
