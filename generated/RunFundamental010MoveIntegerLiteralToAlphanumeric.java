...
public class RunFundamental010MoveIntegerLiteralToAlphanumeric extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFundamental010MoveIntegerLiteralToAlphanumeric");
            CobolProgram.registerCallAlias("prog", "RunFundamental010MoveIntegerLiteralToAlphanumeric");
    ...
    public static void main(String[] args) {
        ...
        new RunFundamental010MoveIntegerLiteralToAlphanumeric().run();
    }
}
