...
public class RunAccept005AcceptOmittedScreen extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunAccept005AcceptOmittedScreen");
            CobolProgram.registerCallAlias("prog", "RunAccept005AcceptOmittedScreen");
    ...
    public static void main(String[] args) {
        ...
        new RunAccept005AcceptOmittedScreen().run();
    }
}
