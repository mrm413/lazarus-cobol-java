...
public class RunFundamental035GlobalFd2 extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFundamental035GlobalFd2");
            CobolProgram.registerCallAlias("prog2", "RunFundamental035GlobalFd2_Prog2");
            CobolProgram.registerCallAlias("prog", "RunFundamental035GlobalFd2");
    ...
    public static void main(String[] args) {
        ...
        new RunFundamental035GlobalFd2().run();
    }
}

class RunFundamental035GlobalFd2_Prog2 extends CobolProgram {
    ...
    private CobolFile test_file = RunFundamental035GlobalFd2.test_file; // GLOBAL FD from RunFundamental035GlobalFd2
    private void para_main() {
        test_file.read(null);
        if (test_file.getFileStatus() != null && test_file.getFileStatus().startsWith("2")) {
    ...
    public static void main(String[] args) {
        ...
        CobolIntrinsics.setCommandLineArgs(args);
        new RunFundamental035GlobalFd2_Prog2().run();
    }
}
