...
public class RunMisc047InspectConvertingNull extends CobolProgram {
    ...
    private void para_main() {
        ...
        if (!CobolString.cobolEquals(String.valueOf(x), String.valueOf("AAA"))) {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunMisc047InspectConvertingNull");
            CobolProgram.registerCallAlias("prog", "RunMisc047InspectConvertingNull");
    ...
    public static void main(String[] args) {
        ...
        new RunMisc047InspectConvertingNull().run();
    }
}
