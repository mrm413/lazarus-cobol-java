...
public class RunFile003OutputOnSequentialFileToMissingDirectory extends CobolProgram {
    ...
    // FILE DESCRIPTORS
    private CobolFile file0 = new CobolFile("./nosubhere/MYFILE0", "SEQUENTIAL", "SEQUENTIAL", "FILE0");
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFile003OutputOnSequentialFileToMissingDirectory");
            CobolProgram.registerCallAlias("prog", "RunFile003OutputOnSequentialFileToMissingDirectory");
