...
public class RunFunctions031FunctionFormattedDate extends CobolProgram {
    ...
    private void para_main() {
        ...
        if (!CobolString.cobolEquals(String.valueOf(str), String.valueOf("2011W527"))) {
        ...
        if (!CobolString.cobolEquals(String.valueOf(str), String.valueOf("2014W011"))) {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFunctions031FunctionFormattedDate");
            CobolProgram.registerCallAlias("prog", "RunFunctions031FunctionFormattedDate");
