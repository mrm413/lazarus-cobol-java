...
public class RunExtensions027CallByValueAlphanumericItem extends CobolProgram {
    ...
    private void para_main() {
        CobolProgram.callNested("prog2", new com.lazarus.cobol.CobolString(2, String.valueOf(x)));
        if (!CobolString.cobolEquals(String.valueOf(x), String.valueOf("OK"))) {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunExtensions027CallByValueAlphanumericItem");
            CobolProgram.registerCallAlias("prog2", "RunExtensions027CallByValueAlphanumericItem_Prog2");
            CobolProgram.registerCallAlias("prog", "RunExtensions027CallByValueAlphanumericItem");
...
class RunExtensions027CallByValueAlphanumericItem_Prog2 extends CobolProgram {
    ...
    public void setLinkageArgs(Object[] args) {
        if (args.length > 0 && args[0] != null) {
            if (args[0] instanceof CobolString) y = (CobolString) args[0]; else y.set(String.valueOf(args[0]));
        }
    }
    public static void main(String[] args) {
        if (args.length > 0 && "--cobol-child".equals(args[0])) {
        ...
        CobolIntrinsics.setCommandLineArgs(args);
        new RunExtensions027CallByValueAlphanumericItem_Prog2().run();
    }
}
