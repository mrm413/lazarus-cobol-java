...
public class RunReportwriter022MissingInitiateAndGenerate extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunReportwriter022MissingInitiateAndGenerate");
            CobolProgram.registerCallAlias("prog", "RunReportwriter022MissingInitiateAndGenerate");
    ...
    public static void main(String[] args) {
        ...
        new RunReportwriter022MissingInitiateAndGenerate().run();
    }
}
