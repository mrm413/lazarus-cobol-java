...
public class RunFundamental107MoveWithDeEdittingToComp5 extends CobolProgram {
    public static final String COBOL_PROGRAM_ID = "MoveDeEditing_5";
    ...
    @SuppressWarnings("unused") private final com.lazarus.cobol.vmg.FieldDescriptor _vmgfd_disp_1 = com.lazarus.cobol.vmg.FieldDescriptor.builder().grid(_vmg_grid).at(10, 4).storage(com.lazarus.cobol.vmg.FieldDescriptor.Storage.BINARY).name("DISP-1").picDigits(6).picScale(2).signed(true).build();
    @SuppressWarnings("unused") private final com.lazarus.cobol.vmg.FieldDescriptor _vmgfd_edit_2 = com.lazarus.cobol.vmg.FieldDescriptor.builder().grid(_vmg_grid).at(14, 13).storage(com.lazarus.cobol.vmg.FieldDescriptor.Storage.EDITED).name("EDIT-2").picDigits(9).build();
    @SuppressWarnings("unused") private final com.lazarus.cobol.vmg.FieldDescriptor _vmgfd_disp_2 = com.lazarus.cobol.vmg.FieldDescriptor.builder().grid(_vmg_grid).at(27, 4).storage(com.lazarus.cobol.vmg.FieldDescriptor.Storage.BINARY).name("DISP-2").picDigits(8).picScale(1).signed(true).build();
    ...
    private void para_main() {
        ...
        if (disp_1.compareTo(new BigDecimal("-123.45")) != 0) {
            CobolDisplay.display("Error 1: DISP-1 <" + CobolDisplay.formatPic(disp_1, 20, 2, true, "LEADING") + "> != -0123.45");
        }
        ...
        if (disp_2.compareTo(new BigDecimal("-42.987600")) != 0) {
            CobolDisplay.display("Error 3: DISP-2 <" + CobolDisplay.formatPic(disp_2, 20, 6, true, "LEADING") + "> != <-42.987600>");
        }
    ...
    @Override
    public void run() {
        CobolIntrinsics.setModuleInfo("MoveDeEditing_5", "", "MoveDeEditing_5.cob");
        CobolProgram.pushActive("MoveDeEditing_5");
        try {
            CobolProgram.registerCallAlias("MoveDeEditing_5", "RunFundamental107MoveWithDeEdittingToComp5");
            CobolProgram.registerCallAlias("movedeediting_5", "RunFundamental107MoveWithDeEdittingToComp5");
