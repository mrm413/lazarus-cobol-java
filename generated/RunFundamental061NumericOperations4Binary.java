...
public class RunFundamental061NumericOperations4Binary extends CobolProgram {
    ...
    private void do_check() {
        ...
        feld4 = (short) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(2), 1);
        feld4 = (short) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(CobolIntrinsics.toBigDecimal(feld4).add(CobolIntrinsics.toBigDecimal(1))), 1);
        if (feld4 != 3) {
            if (filler_1 == 0) {
        ...
        feld4 = (short) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(2), 1);
        feld4 = (short) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(CobolIntrinsics.toBigDecimal(feld4).subtract(CobolIntrinsics.toBigDecimal(1))), 1);
        if (feld4 != 1) {
            if (filler_1 == 0) {
        ...
        feld4 = (short) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(1), 1);
        feld4 = (short) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(CobolIntrinsics.toBigDecimal(feld4).add(CobolIntrinsics.toBigDecimal(2))), 1);
        if (feld4 != 3) {
            if (filler_1 == 0) {
        ...
        feld4 = (short) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(1), 1);
        feld4 = (short) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(CobolIntrinsics.toBigDecimal(feld4).subtract(CobolIntrinsics.toBigDecimal(2))), 1);
        if (feld4 != -1) {
            if (filler_1 == 0) {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFundamental061NumericOperations4Binary");
            CobolProgram.registerCallAlias("prog", "RunFundamental061NumericOperations4Binary");
