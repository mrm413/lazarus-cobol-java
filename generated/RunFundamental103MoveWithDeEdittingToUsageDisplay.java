...
public class RunFundamental103MoveWithDeEdittingToUsageDisplay extends CobolProgram {
    public static final String COBOL_PROGRAM_ID = "MoveDeEditing";
    ...
    @Override
    public void run() {
        CobolIntrinsics.setModuleInfo("MoveDeEditing", "", "MoveDeEditing.cob");
        CobolProgram.pushActive("MoveDeEditing");
        try {
            CobolProgram.registerCallAlias("MoveDeEditing", "RunFundamental103MoveWithDeEdittingToUsageDisplay");
            CobolProgram.registerCallAlias("movedeediting", "RunFundamental103MoveWithDeEdittingToUsageDisplay");
    ...
    public static void main(String[] args) {
        ...
        new RunFundamental103MoveWithDeEdittingToUsageDisplay().run();
    }
}
