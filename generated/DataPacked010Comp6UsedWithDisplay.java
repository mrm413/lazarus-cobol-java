...
public class DataPacked010Comp6UsedWithDisplay extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "DataPacked010Comp6UsedWithDisplay");
            CobolProgram.registerCallAlias("prog", "DataPacked010Comp6UsedWithDisplay");
    ...
    public static void main(String[] args) {
        ...
        new DataPacked010Comp6UsedWithDisplay().run();
    }
}
