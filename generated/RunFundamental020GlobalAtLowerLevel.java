...
public class RunFundamental020GlobalAtLowerLevel extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFundamental020GlobalAtLowerLevel");
            CobolProgram.registerCallAlias("prog2", "RunFundamental020GlobalAtLowerLevel_Prog2");
            CobolProgram.registerCallAlias("prog", "RunFundamental020GlobalAtLowerLevel");
    ...
    public static void main(String[] args) {
        ...
        new RunFundamental020GlobalAtLowerLevel().run();
    }
}

class RunFundamental020GlobalAtLowerLevel_Prog2 extends CobolProgram {
    ...
    public void run() {
        ...
        try {
            ...
            CobolProgram.registerCallAlias("prog2", "RunFundamental020GlobalAtLowerLevel_Prog2");
            CobolProgram.registerCallAlias("prog", "RunFundamental020GlobalAtLowerLevel");
            CobolProgram.registerCallAlias("prog3", "RunFundamental020GlobalAtLowerLevel_Prog2_Prog3");
            CobolDisplay.setDecimalPointIsComma(false);
            CobolDisplay.setDpcInDataMode("DEFAULT");
            CobolIntrinsics.setLocationEnabled(false);
            // Register own GLOBAL fields for dynamic inherited-GLOBAL resolution
    ...
    public static void main(String[] args) {
        ...
        CobolIntrinsics.setCommandLineArgs(args);
        new RunFundamental020GlobalAtLowerLevel_Prog2().run();
    }
}

class RunFundamental020GlobalAtLowerLevel_Prog2_Prog3 extends CobolProgram {
    ...
    private CobolString x = RunFundamental020GlobalAtLowerLevel_Prog2.x; // GLOBAL from RunFundamental020GlobalAtLowerLevel_Prog2
    private void para_main() {
        CobolDisplay.display(String.valueOf(x));
        return;
    }
    ...
    public void run() {
        ...
        try {
            ...
            x = CobolProgram.resolveInheritedGlobal("X", RunFundamental020GlobalAtLowerLevel_Prog2.x);
            para_main();
        } finally { CobolProgram.popActive(); }
    }
    public static void main(String[] args) {
        ...
        CobolIntrinsics.setCommandLineArgs(args);
        new RunFundamental020GlobalAtLowerLevel_Prog2_Prog3().run();
    }
}
