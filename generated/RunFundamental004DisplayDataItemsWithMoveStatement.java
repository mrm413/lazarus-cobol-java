...
public class RunFundamental004DisplayDataItemsWithMoveStatement extends CobolProgram {
    ...
    private void para_main() {
        ...
        x_123 = (int) Math.abs(CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(123), 3));
        CobolDisplay.display(CobolDisplay.formatPic(x_123, 3, 0, false));
        x_p123 = (int) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(123), 3);
        CobolDisplay.display(CobolDisplay.formatPic(x_p123, 3, 0, true, "LEADING"));
        x_n123 = (int) CobolIntrinsics.truncateBigDecimalInt(CobolIntrinsics.toBigDecimal(-123), 3);
        CobolDisplay.display(CobolDisplay.formatPic(x_n123, 3, 0, true, "LEADING"));
        x_12_3 = CobolIntrinsics.truncateToField(CobolIntrinsics.toBigDecimal(new BigDecimal("12.3")), 3, 1, false);
        CobolDisplay.display(CobolDisplay.formatPic(x_12_3, 3, 1, false));
        x_p12_3 = CobolIntrinsics.truncateToField(CobolIntrinsics.toBigDecimal(new BigDecimal("+12.3")), 3, 1, true);
        CobolDisplay.display(CobolDisplay.formatPic(x_p12_3, 3, 1, true, "LEADING"));
        x_n12_3 = CobolIntrinsics.truncateToField(CobolIntrinsics.toBigDecimal(new BigDecimal("-12.3")), 3, 1, true);
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunFundamental004DisplayDataItemsWithMoveStatement");
            CobolProgram.registerCallAlias("prog", "RunFundamental004DisplayDataItemsWithMoveStatement");
