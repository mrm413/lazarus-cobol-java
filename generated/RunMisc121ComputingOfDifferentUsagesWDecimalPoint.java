...
public class RunMisc121ComputingOfDifferentUsagesWDecimalPoint extends CobolProgram {
    ...
    private BigDecimal c3_a = new BigDecimal("1.0");
    private BigDecimal c3_b = new BigDecimal("10.0");
    ...
    private BigDecimal c6_a = new BigDecimal("1.0");
    private BigDecimal c6_b = new BigDecimal("10.0");
    ...
    private int d_b = 10;
    private int d_res = 0;
    private BigDecimal fd16_a = new BigDecimal("1.0");
    private BigDecimal fd16_b = new BigDecimal("10.0");
    private BigDecimal fd16_res = BigDecimal.ZERO;
    private BigDecimal fd34_a = new BigDecimal("1.0");
    private BigDecimal fd34_b = new BigDecimal("10.0");
    ...
    private final com.lazarus.cobol.vmg.MemoryGrid _vmg_grid = new com.lazarus.cobol.vmg.MemoryGrid(66);
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunMisc121ComputingOfDifferentUsagesWDecimalPoint");
            CobolProgram.registerCallAlias("prog", "RunMisc121ComputingOfDifferentUsagesWDecimalPoint");
