...
public class RunSubscripts000SubscriptOutOfBounds extends CobolProgram {
    ...
    @SuppressWarnings("unused") private final com.lazarus.cobol.vmg.FieldDescriptor _vmgfd_i = com.lazarus.cobol.vmg.FieldDescriptor.builder().grid(_vmg_grid).at(10, 1).storage(com.lazarus.cobol.vmg.FieldDescriptor.Storage.NUMERIC_DISPLAY).name("I").picDigits(1).build();


    private void para_main() {
        CobolDisplay.display(String.valueOf(CobolString.safeIndex(x, i, 1, g, 0)));
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunSubscripts000SubscriptOutOfBounds");
            CobolProgram.registerCallAlias("prog", "RunSubscripts000SubscriptOutOfBounds");
    ...
    public static void main(String[] args) {
        ...
        new RunSubscripts000SubscriptOutOfBounds().run();
    }
}
