...
public class SynMisc036ContinuationOfCobolWords extends CobolProgram {
    ...
    private void back() { /* stub — external/COPY */ }
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "SynMisc036ContinuationOfCobolWords");
            CobolProgram.registerCallAlias("prog", "SynMisc036ContinuationOfCobolWords");
