...
public class RunMisc028IndexAndParenthesizedExpression extends CobolProgram {
    ...
    @SuppressWarnings("unused") private final com.lazarus.cobol.vmg.FieldDescriptor _vmgfd_g = com.lazarus.cobol.vmg.FieldDescriptor.builder().grid(_vmg_grid).at(0, 1).storage(com.lazarus.cobol.vmg.FieldDescriptor.Storage.GROUP).name("G").build();
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunMisc028IndexAndParenthesizedExpression");
            CobolProgram.registerCallAlias("prog", "RunMisc028IndexAndParenthesizedExpression");
    ...
    public static void main(String[] args) {
        ...
        new RunMisc028IndexAndParenthesizedExpression().run();
    }
}
