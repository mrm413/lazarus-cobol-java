...
public class SynDefinition037CallByValueAlphanumericItemExtension extends CobolProgram {
    ...
    private void para_main() {
        CobolProgram.call("PROG2", new com.lazarus.cobol.CobolString(4, String.valueOf(x)));
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "SynDefinition037CallByValueAlphanumericItemExtension");
            CobolProgram.registerCallAlias("prog", "SynDefinition037CallByValueAlphanumericItemExtension");
    ...
    public static void main(String[] args) {
        ...
        new SynDefinition037CallByValueAlphanumericItemExtension().run();
    }
}
