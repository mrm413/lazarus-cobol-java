...
public class RunMisc018MoveIndexes extends CobolProgram {
    ...
    private void para_main() {
        i = (int) Math.abs(CobolIntrinsics.toBigDecimal(0).intValue());
        if (x[1 - 1] == null) x[1 - 1] = new CobolString(1);
        x[1 - 1].set(String.valueOf(i));
        if (!CobolString.cobolEquals(String.valueOf(x[1 - 1]), String.valueOf("0"))) {
    ...
    public void run() {
        ...
        try {
            CobolProgram.registerCallAlias("prog", "RunMisc018MoveIndexes");
            CobolProgram.registerCallAlias("prog", "RunMisc018MoveIndexes");
