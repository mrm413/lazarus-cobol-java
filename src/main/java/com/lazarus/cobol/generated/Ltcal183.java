...
public class Ltcal183 extends CobolProgram {
    private int tally = 0;
    ...
    private void pps_nat_nonlabor_pct() {
        if (String.valueOf(p_new_hosp_qual_ind).equals(String.valueOf("1"))) {
            pps_std_fed_rate = new BigDecimal(String.valueOf(41415.11).trim()).intValue();
        } else {
    ...
    private void h_ipps_wage_index() {
        if (Integer.parseInt(String.valueOf(h_ipps_wage_index).trim()) > 1) {
            h_ipps_nat_labor_shr.set(String.valueOf(3806.04));
            h_ipps_nat_nonlabor_shr.set(String.valueOf(1766.49));
        } else {
            h_ipps_nat_labor_shr.set(String.valueOf(3454.97));
            h_ipps_nat_nonlabor_shr.set(String.valueOf(2117.56));
        }
    }
