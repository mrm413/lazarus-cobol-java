...
public class RunMl010JsonGenerateRecordSelection extends CobolProgram {
    private int tally = 0;
    ...
    private void para_main() {
        ...
        if (!String.valueOf(out).equals(String.valueOf("{\"d\":{\"e\":\"abc000\"}}"))) {
    ...
    public static void main(String[] args) {
        new RunMl010JsonGenerateRecordSelection().run();
    }
}
