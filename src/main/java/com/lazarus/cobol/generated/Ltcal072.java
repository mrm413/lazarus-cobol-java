...
public class Ltcal072 extends CobolProgram {
    private int tally = 0;
    ...
    private void h_pr_ipps_pmt_pct() {
        if (w_ipps_wage_index.compareTo(new BigDecimal(String.valueOf(1).trim())) > 0) {
            h_ipps_nat_labor_shr.set(String.valueOf(3297.84));
            h_ipps_nat_nonlabor_shr.set(String.valueOf(1433.63));
        } else {
            h_ipps_nat_labor_shr.set(String.valueOf(2933.52));
            h_ipps_nat_nonlabor_shr.set(String.valueOf(1797.95));
        }
        if (w_ipps_pr_wage_index.compareTo(new BigDecimal(String.valueOf(1).trim())) > 0) {
            h_ipps_pr_labor_shr.set(String.valueOf(1402.46));
            h_ipps_pr_nonlabor_shr.set(String.valueOf(859.57));
        } else {
            h_ipps_pr_labor_shr.set(String.valueOf(1327.81));
            h_ipps_pr_nonlabor_shr.set(String.valueOf(934.22));
        }
        /* RAW: 0100 - */
        return;
    }
    ...
    private void ss_ipps_comp_pmt() {
        h_oper_ime_teach.set(String.valueOf((1.37 * ((Math.pow(((1 + Integer.parseInt(String.valueOf(h_intern_ratio).trim()))), 0.405) - 1)))));
