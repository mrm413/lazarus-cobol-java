...
public class RunManualScreen044SpecialNamesCursorPhrase4DigitWithField extends CobolProgram {
    private int tally = 0;
    ...
    private void testme() {
        ...
        cur_pos = new BigDecimal(String.valueOf(503).trim()).intValue();
        ws_x_20.set(String.valueOf(CobolDisplay.accept()));
        /* RAW: LINE 5 COLUMN 1 WITH AUTO-SKIP */
        if ((cur_pos == 505 && cob_crt_status == 0)) {
            return;
        } else {
            return;
        }
    ...
    public static void main(String[] args) {
        new RunManualScreen044SpecialNamesCursorPhrase4DigitWithField().run();
    }
}
