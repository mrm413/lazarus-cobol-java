...
public class RunFundamental086UseForDebuggingReferenceWithinDebugging extends CobolProgram {
    private int tally = 0;
    ...
    public static void main(String[] args) {
        new RunFundamental086UseForDebuggingReferenceWithinDebugging().run();
    }
}
