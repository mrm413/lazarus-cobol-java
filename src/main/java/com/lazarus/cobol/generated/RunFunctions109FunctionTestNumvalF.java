...
public class RunFunctions109FunctionTestNumvalF extends CobolProgram {
    ...
    private void para_main() {
        result = new BigDecimal(String.valueOf(CobolIntrinsics.test_numval_f("+ 1")).trim()).intValue();
        if (result != 0) {
        ...
        result = new BigDecimal(String.valueOf(CobolIntrinsics.test_numval_f("+ 1.1")).trim()).intValue();
        if (result != 0) {
        ...
        result = new BigDecimal(String.valueOf(CobolIntrinsics.test_numval_f("1.1 -CR")).trim()).intValue();
        if (result != 6) {
            CobolDisplay.display("Test 16 fail: ");
            /* RAW: RESULT  */
        }
        result = new BigDecimal(String.valueOf(CobolIntrinsics.test_numval_f("1.1 E+1")).trim()).intValue();
        if (result != 0) {
        ...
        result = new BigDecimal(String.valueOf(CobolIntrinsics.test_numval_f("1.1 EE")).trim()).intValue();
        if (result != 6) {
            CobolDisplay.display("Test 19 fail: ");
            /* RAW: RESULT  */
        }
        result = new BigDecimal(String.valueOf(CobolIntrinsics.test_numval_f("+1.1 E001")).trim()).intValue();
        if (result != 7) {
