...
public class RunManualScreen041Update extends CobolProgram {
    private int tally = 0;
    ...
    private CobolString n_str = new CobolString(12);
    ...
    public static void main(String[] args) {
        new RunManualScreen041Update().run();
    }
}
