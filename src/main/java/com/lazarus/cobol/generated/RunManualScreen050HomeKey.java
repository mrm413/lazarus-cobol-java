...
public class RunManualScreen050HomeKey extends CobolProgram {
    private int tally = 0;
    ...
    private void para_main() {
        CobolDisplay.display("Enter 'y' if multiple presses of the HOME key" + String.valueOf(line) + String.valueOf(1) + String.valueOf(column) + String.valueOf(1));
        CobolDisplay.display("go to the beginning of the field and the beginning" + String.valueOf(line) + String.valueOf(2) + String.valueOf(column) + String.valueOf(1));
    ...
    public static void main(String[] args) {
        new RunManualScreen050HomeKey().run();
    }
}
