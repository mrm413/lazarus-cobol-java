...
public class Escal080 extends CobolProgram {
    private int tally = 0;
    ...
    private int h_2006_wage_adj_pymt = 0;
    private int h_2007_wage_adj_pymt = 0;
    private int h_2008_wage_adj_pymt = 0;
    ...
    private int msa_wage_factor_2006 = 0;
    private int msa_wage_factor_2007 = 0;
    private int msa_wage_factor_2008 = 0;
    ...
    private void pps_calc_vers_cd() {
        if ((String.valueOf(p_prov_type).equals(String.valueOf("40")) || true)) {
            ...
            h_2006_wage_adj_pymt = new BigDecimal(String.valueOf((Integer.parseInt(String.valueOf(w_new_rate1_record).trim()) * msa_wage_factor_2006)).trim()).intValue();
            h_2007_wage_adj_pymt = new BigDecimal(String.valueOf((h_2006_wage_adj_pymt * msa_wage_factor_2007)).trim()).intValue();
            h_2008_wage_adj_pymt = new BigDecimal(String.valueOf((h_2007_wage_adj_pymt * msa_wage_factor_2008)).trim()).intValue();
            h_wage_adj_pymt_old = new BigDecimal(String.valueOf(h_2008_wage_adj_pymt).trim()).intValue();
            ...
            if (String.valueOf(p_prov_type).equals(String.valueOf("41"))) {
                ...
                h_2006_wage_adj_pymt = new BigDecimal(String.valueOf((Integer.parseInt(String.valueOf(w_new_rate2_record).trim()) * msa_wage_factor_2006)).trim()).intValue();
                h_2007_wage_adj_pymt = new BigDecimal(String.valueOf((h_2006_wage_adj_pymt * msa_wage_factor_2007)).trim()).intValue();
                h_2008_wage_adj_pymt = new BigDecimal(String.valueOf((h_2007_wage_adj_pymt * msa_wage_factor_2008)).trim()).intValue();
                h_wage_adj_pymt_old = new BigDecimal(String.valueOf(h_2008_wage_adj_pymt).trim()).intValue();
    ...
    private void calc_payment() {
        h_wage_adj_pymt_old = new BigDecimal(String.valueOf(((h_wage_adj_pymt_old * msa_blend_pct))).trim()).intValue();
