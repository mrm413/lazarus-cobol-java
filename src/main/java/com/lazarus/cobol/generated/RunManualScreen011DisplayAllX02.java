...
public class RunManualScreen011DisplayAllX02 extends CobolProgram {
    private int tally = 0;
    ...
    private void para_main() {
        ...
        CobolDisplay.display("02" + String.valueOf(at) + String.valueOf(line) + String.valueOf(6) + String.valueOf(col) + String.valueOf(8) + "foo" + String.valueOf(highlight));
        CobolDisplay.display(String.valueOf(scr_3));
        scr_3.set(String.valueOf(CobolDisplay.accept()));
    ...
    public static void main(String[] args) {
        new RunManualScreen011DisplayAllX02().run();
    }
}
