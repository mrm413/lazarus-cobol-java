...
public class Escal202 extends CobolProgram {
    private int tally = 0;
    ...
    // h_full_claim_amt = new BigDecimal(String.valueOf((((h_bun_adjusted_base_wage_amt * (((b_claim_num_dialysis_sessions) * 3))) / 7))).trim()).intValue();
        ...
        h_final_amt_without_hdpa = new BigDecimal(String.valueOf((h_final_amt_without_hdpa + h_tdapa_payment)).trim()).intValue();
        h_final_amt_with_hdpa = new BigDecimal(String.valueOf((h_final_amt_with_hdpa + h_tdapa_payment)).trim()).intValue();
