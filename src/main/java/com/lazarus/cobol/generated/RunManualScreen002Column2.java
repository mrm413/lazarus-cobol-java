...
public class RunManualScreen002Column2 extends CobolProgram {
    private int tally = 0;
    ...
    private CobolString dummy_1 = new CobolString(10);
    private CobolString dummy_2 = new CobolString(10);
    private CobolString dummy_3 = new CobolString(10);
    ...
    public static void main(String[] args) {
        new RunManualScreen002Column2().run();
    }
}
