...
public class RunFile080ExtfhLineSequentialFiles2 extends CobolProgram {
    ...
    private CobolString lseq_filename = new CobolString(256);
    ...
    private CobolString lseq_recordarea = new CobolString(256);
    private CobolString fcd_max_rec_length = new CobolString(256);
    private CobolString fcd_recmode_variable = new CobolString(256);
    ...
    private CobolString lseq_tx = new CobolString(256);
    private CobolString lseq_tcount = new CobolString(256);
    private CobolString extfh_opcode_iswrite = new CobolString(256);
    private CobolString[] lseq_test_len = new CobolString[100];
