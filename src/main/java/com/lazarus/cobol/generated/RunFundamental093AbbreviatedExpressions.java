...
public class RunFundamental093AbbreviatedExpressions extends CobolProgram {
    ...
    private CobolString fld9_7 = new CobolString(256);
    private CobolString fld9_5 = new CobolString(256);
    private CobolString _unnamed = new CobolString(256);
    private CobolString fld9_1 = new CobolString(256);
    private CobolString fld9_2 = new CobolString(256);
    private CobolString fld9_9 = new CobolString(256);
    private CobolString on_wrk_switch_1 = new CobolString(256);
    private CobolString off_wrk_switch_2 = new CobolString(256);
    private CobolString off_wrk_switch_1 = new CobolString(256);
    private CobolString testnum = new CobolString(256);

    private void main_line() {
        if ((String.valueOf(fld9_7).compareTo(String.valueOf(fld9_5)) > 0 && !(!String.valueOf(_unnamed).trim().isEmpty()))) {
        ...
        if (!((String.valueOf(fld9_5).compareTo(String.valueOf(fld9_7)) > 0 || !String.valueOf(_unnamed).trim().isEmpty()))) {
            /* RAW: FLD9-1 ) */
            pass();
        } else {
            fail();
        ...
        if ((5 > 1 && !String.valueOf(_unnamed).trim().isEmpty())) {
            /* RAW: 3 OR 6 */
            pass();
        } else {
            fail();
