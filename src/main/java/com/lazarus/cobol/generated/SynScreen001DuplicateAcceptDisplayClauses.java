...
public class SynScreen001DuplicateAcceptDisplayClauses extends CobolProgram {
    private int tally = 0;
    ...
    private void para_main() {
        ...
        /* RAW: LINE 1 COL 1 HIGHLIGHT LINE */
    }
    ...
    public static void main(String[] args) {
        new SynScreen001DuplicateAcceptDisplayClauses().run();
    }
}
