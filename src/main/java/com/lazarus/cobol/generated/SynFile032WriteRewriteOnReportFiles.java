...
public class SynFile032WriteRewriteOnReportFiles extends CobolProgram {
    private int tally = 0;
    ...
    // FILE SECTION — f
    private CobolString f_rec = new CobolString(5);
    ...
    public static void main(String[] args) {
        new SynFile032WriteRewriteOnReportFiles().run();
    }
}
