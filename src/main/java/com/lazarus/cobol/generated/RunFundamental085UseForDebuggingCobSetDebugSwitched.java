...
public class RunFundamental085UseForDebuggingCobSetDebugSwitched extends CobolProgram {
    private int tally = 0;
    ...
    private void first_par() {
        ...
        cob_set_debug.set(String.valueOf("false"));
    ...
    private void third_par() {
        ...
        environment.set(String.valueOf("Y"));
        cob_set_debug.set(String.valueOf("Y"));
        second_par();
    ...
    public static void main(String[] args) {
        new RunFundamental085UseForDebuggingCobSetDebugSwitched().run();
    }
}
