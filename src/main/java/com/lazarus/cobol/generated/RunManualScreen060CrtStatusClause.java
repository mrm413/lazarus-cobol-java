...
public class RunManualScreen060CrtStatusClause extends CobolProgram {
    private int tally = 0;
    ...
    private int[] test_crt4 = new int[7];
    private int linenr = 0;
    private int test_result_4 = 0;
    ...
    private void para_main() {
        ...
        while (true) {
            ...
            for (loop = 1; !(loop > 7); loop += 1) {
                ...
                CobolDisplay.display(String.valueOf(crt4) + String.valueOf(line) + String.valueOf(linenr) + String.valueOf(_filler_004) + String.valueOf(column) + String.valueOf(30));
                if (crt4 == test_crt4[loop - 1]) {
                    CobolDisplay.display("passed" + String.valueOf(line) + String.valueOf(linenr) + String.valueOf(_filler_005) + String.valueOf(column) + String.valueOf(36));
                } else {
                    return_value = new BigDecimal(String.valueOf(1).trim()).intValue();
                    CobolDisplay.display("failed" + String.valueOf(line) + String.valueOf(linenr) + String.valueOf(_filler_006) + String.valueOf(column) + String.valueOf(36));
                }
            }
            if (return_value == 0) {
                break;
            }
            CobolDisplay.display("Try again? (Y/n) " + String.valueOf(line) + String.valueOf(20) + String.valueOf(_filler_007) + String.valueOf(column) + String.valueOf(1));
    ...
    public static void main(String[] args) {
        new RunManualScreen060CrtStatusClause().run();
    }
}
