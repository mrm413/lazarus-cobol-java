...
public class Ltcal141 extends CobolProgram {
    private int tally = 0;
    ...
    private void pps_nat_nonlabor_pct() {
        if (String.valueOf(p_new_hosp_qual_ind).equals(String.valueOf("1"))) {
            pps_std_fed_rate = new BigDecimal(String.valueOf(40607.31).trim()).intValue();
        } else {
    ...
    private void h_pr_ipps_pmt_pct() {
        if (Integer.parseInt(String.valueOf(h_ipps_wage_index).trim()) > 1) {
            h_ipps_nat_labor_shr.set(String.valueOf(3737.71));
            h_ipps_nat_nonlabor_shr.set(String.valueOf(1632.57));
        } else {
            h_ipps_nat_labor_shr.set(String.valueOf(3329.57));
            h_ipps_nat_nonlabor_shr.set(String.valueOf(2040.71));
        }
        if (w_ipps_pr_wage_index.compareTo(new BigDecimal(String.valueOf(1).trim())) > 0) {
            h_ipps_pr_labor_shr.set(String.valueOf(1608.9));
            h_ipps_pr_nonlabor_shr.set(String.valueOf(936.82));
        } else {
            h_ipps_pr_labor_shr.set(String.valueOf(1578.35));
            h_ipps_pr_nonlabor_shr.set(String.valueOf(967.37));
        }
    }
