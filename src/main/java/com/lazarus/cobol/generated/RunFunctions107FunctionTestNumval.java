...
public class RunFunctions107FunctionTestNumval extends CobolProgram {
    ...
    private void para_main() {
        ...
        if (result != 0) {
            CobolDisplay.display("Test 21 fail: " + String.valueOf(result));
        }
        result = new BigDecimal(String.valueOf(CobolIntrinsics.test_numval("  .0   ")).trim()).intValue();
        if (result != 0) {
            CobolDisplay.display("Test 22 fail: " + String.valueOf(result));
        }
        result = new BigDecimal(String.valueOf(CobolIntrinsics.test_numval("  . 0")).trim()).intValue();
        if (result != 4) {
            CobolDisplay.display("Test 23 fail: " + String.valueOf(result));
        }
        result = new BigDecimal(String.valueOf(CobolIntrinsics.test_numval("  0 .")).trim()).intValue();
        if (result != 5) {
            CobolDisplay.display("Test 24 fail: " + String.valueOf(result));
        }
        result = new BigDecimal(String.valueOf(CobolIntrinsics.test_numval("   0+0")).trim()).intValue();
        if (result != 6) {
            CobolDisplay.display("Test 25 fail: " + String.valueOf(result));
        }
        result = new BigDecimal(String.valueOf(CobolIntrinsics.test_numval("   0+  0")).trim()).intValue();
        if (result != 8) {
            CobolDisplay.display("Test 26 fail: " + String.valueOf(result));
        }
        result = new BigDecimal(String.valueOf(CobolIntrinsics.test_numval("1.1 D")).trim()).intValue();
        if (result != 6) {
            CobolDisplay.display("Test 27 fail: " + String.valueOf(result));
        }
        /* RAW: *  */
        result = new BigDecimal(String.valueOf(CobolIntrinsics.test_numval("")).trim()).intValue();
        ...
        if (result != 1) {
            CobolDisplay.display("Test 28 fail: " + String.valueOf(result));
        }
        result = new BigDecimal(String.valueOf(CobolIntrinsics.test_numval("   ")).trim()).intValue();
        if (result != 4) {
            CobolDisplay.display("Test 29 fail: " + String.valueOf(result));
        }
        result = new BigDecimal(String.valueOf(CobolIntrinsics.test_numval("  .")).trim()).intValue();
        if (result != 4) {
            CobolDisplay.display("Test 30 fail: " + String.valueOf(result));
        }
        result = new BigDecimal(String.valueOf(CobolIntrinsics.test_numval("    ")).trim()).intValue();
        if (result != 5) {
            CobolDisplay.display("Test 31 fail: " + String.valueOf(result));
        }
        result = new BigDecimal(String.valueOf(CobolIntrinsics.test_numval(" 1  T")).trim()).intValue();
        if (result != 5) {
            CobolDisplay.display("Test 32 fail: " + String.valueOf(result));
        }
        System.exit(0);
    }
