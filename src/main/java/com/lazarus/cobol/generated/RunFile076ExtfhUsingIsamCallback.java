...
public class RunFile076ExtfhUsingIsamCallback extends CobolProgram {
    private int tally = 0;
    ...
    private void tspfile_2() {
        ...
        if (!String.valueOf(cust_stat).equals(String.valueOf("00"))) {
            CobolDisplay.display("Expected ERROR " + String.valueOf(cust_stat) + " opening TSTFILE, Record size different");
        } else {
            CobolDisplay.display("Un-Expected open TSTFILE, Record size different");
            tstfile.close();
        }
        loadflat();
        System.exit(0);
    ...
    public static void main(String[] args) {
        new RunFile076ExtfhUsingIsamCallback().run();
    }
}
