...
public class DataDisplay005PppDisplay extends CobolProgram {
    ...
    private void para_main() {
        ...
        x_2 = new BigDecimal(String.valueOf(d_1).trim()).intValue();
        x_1 = new BigDecimal(String.valueOf(d_1).trim()).intValue();
        d_1 = new BigDecimal(String.valueOf(x_2).trim()).intValue();
        ...
        x_2 = new BigDecimal(String.valueOf(d_2).trim()).intValue();
        x_1 = new BigDecimal(String.valueOf(d_2).trim()).intValue();
        ...
        x_1 = new BigDecimal(String.valueOf(98000).trim()).intValue();
        if (x_1 != 98000) {
            CobolDisplay.display("MOVE 98000 failed: " + String.valueOf(x_1));
        }
        d_1 = new BigDecimal(String.valueOf(98000).trim()).intValue();
        if (d_1 != 98000) {
            CobolDisplay.display("MOVE 98000 failed: " + String.valueOf(d_1));
        }
        x_1 = new BigDecimal(String.valueOf(x_1 + 1000).trim()).intValue();
        if (x_1 != 99000) {
            CobolDisplay.display("+ 1000 failed: " + String.valueOf(x_1));
        }
        x_1 = new BigDecimal(String.valueOf(x_1 - 4000).trim()).intValue();
        if (x_1 != 95000) {
        ...
        x_1 = new BigDecimal(String.valueOf(2 * x_1).trim()).intValue();
        if (x_1 != 62000) {
