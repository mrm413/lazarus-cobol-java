...
public class RunManualScreen061XOpenCrtStatusClause extends CobolProgram {
    private int tally = 0;
    ...
    private void para_main() {
        ...
        while (true) {
            ...
            for (loop = 1; !(loop > 7); loop += 1) {
                ...
                CobolDisplay.display("Please press " + String.valueOf(line) + String.valueOf(linenr) + String.valueOf(_filler_002) + String.valueOf(column) + String.valueOf(1));
                CobolDisplay.display(String.valueOf(test_name[loop - 1]) + String.valueOf(line) + String.valueOf(linenr) + String.valueOf(_filler_003) + String.valueOf(column) + String.valueOf(14));
                ...
                CobolDisplay.display(String.valueOf(test_result_1) + String.valueOf(line) + String.valueOf(linenr) + String.valueOf(_filler_004) + String.valueOf(column) + String.valueOf(30));
                test_result_3 = new BigDecimal(String.valueOf(crt3_2).trim()).intValue();
                CobolDisplay.display(String.valueOf(test_result_3) + String.valueOf(line) + String.valueOf(linenr) + String.valueOf(_filler_005) + String.valueOf(column) + String.valueOf(32));
                if ((test_result_1 == test_crt31[loop - 1] && test_result_3 == test_crt32[loop - 1])) {
                    CobolDisplay.display("passed" + String.valueOf(line) + String.valueOf(linenr) + String.valueOf(_filler_006) + String.valueOf(column) + String.valueOf(36));
                } else {
                    return_value = new BigDecimal(String.valueOf(1).trim()).intValue();
                    CobolDisplay.display("failed" + String.valueOf(line) + String.valueOf(linenr) + String.valueOf(_filler_007) + String.valueOf(column) + String.valueOf(36));
                }
            }
            if (return_value == 0) {
                break;
            }
            CobolDisplay.display("Try again? (Y/n) " + String.valueOf(line) + String.valueOf(20) + String.valueOf(_filler_008) + String.valueOf(column) + String.valueOf(1));
    ...
    public static void main(String[] args) {
        new RunManualScreen061XOpenCrtStatusClause().run();
    }
}
