...
public class SynRedefines008RedefinesWithVariableOccurrence extends CobolProgram {
    private int tally = 0;
    ...
    private CobolString g3 = new CobolString(1); // Group: G3
    private int i = 0;
    ...
    public static void main(String[] args) {
        new SynRedefines008RedefinesWithVariableOccurrence().run();
    }
}
