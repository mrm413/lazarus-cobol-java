...
public class Escal056 extends CobolProgram {
    private int tally = 0;
    ...
    private void pps_calc_vers_cd() {
        if (String.valueOf(p_prov_type).equals(String.valueOf("40"))) {
            pps_nat_labor_pct.set(String.valueOf(0));
            pps_nat_nonlabor_pct.set(String.valueOf(0));
            pps_wage_adj_rate.set(String.valueOf(w_new_rate1_record));
            msa_wage_amt.set(String.valueOf(w_new_rate1_record));
        } else {
            if (String.valueOf(p_prov_type).equals(String.valueOf("41"))) {
                pps_nat_labor_pct.set(String.valueOf(0));
                pps_nat_nonlabor_pct.set(String.valueOf(0));
                pps_wage_adj_rate.set(String.valueOf(w_new_rate2_record));
    ...
    private void h_wage_adj_pymt_amt() {
        ...
        if (Integer.parseInt(String.valueOf(pps_rtc).trim()) < 50) {
            ...
            if (!String.valueOf(old_test_case).trim().isEmpty()) {
                ...
                if ((String.valueOf(p_prov_type).equals(String.valueOf("40")) || true)) {
                    pps_wage_adj_rate.set(String.valueOf(w_new_rate1_record));
                    msa_wage_amt.set(String.valueOf(w_new_rate1_record));
                    msa_wage_adj.set(String.valueOf(w_new_rate1_record));
                } else {
                    pps_wage_adj_rate.set(String.valueOf(w_new_rate2_record));
                    msa_wage_amt.set(String.valueOf(w_new_rate2_record));
                    msa_wage_adj.set(String.valueOf(w_new_rate2_record));
                }
                cbsa_wage_adj.set(String.valueOf(0));
                cbsa_pct.set(String.valueOf(cbsa_blend_pct));
                msa_pct.set(String.valueOf(msa_blend_pct));
                cbsa_wage_pmt_rate.set(String.valueOf(0));
                age_return.set(String.valueOf(h_patient_age));
                cbsa_wage_index.set(String.valueOf(0));
