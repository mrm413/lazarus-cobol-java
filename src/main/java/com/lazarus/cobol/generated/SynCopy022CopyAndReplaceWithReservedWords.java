...
public class SynCopy022CopyAndReplaceWithReservedWords extends CobolProgram {
    private int tally = 0;
    ...
    private void para_main() {
        ...
        if (!String.valueOf(ws_in).trim().isEmpty()) {
            /* RAW: EQUALS IN-A COPY "proc.inc" REPLACING VAR */
        }
        System.exit(0);
    }
    ...
    public static void main(String[] args) {
        new SynCopy022CopyAndReplaceWithReservedWords().run();
    }
}
