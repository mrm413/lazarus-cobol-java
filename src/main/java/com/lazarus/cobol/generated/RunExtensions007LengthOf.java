...
public class RunExtensions007LengthOf extends CobolProgram {
    ...
    private CobolString var_length_l = new CobolString(256); // fallback
    private CobolString var_length_x = new CobolString(256); // fallback
    private CobolString var_length_z = new CobolString(256); // fallback
    ...
    private CobolString tstdisp = new CobolString(256); // fallback
    ...
    private void para_main() {
        ...
        for (int _i1 = 0; _i1 < l.intValue(); _i1++) {
        }
        l = l.add(new BigDecimal(String.valueOf(1).trim()));
        ...
        l = new BigDecimal(String.valueOf(0).trim());
        for (i = Integer.parseInt(String.valueOf(length).trim()); !((i != 0)); i += 1) {
        }
