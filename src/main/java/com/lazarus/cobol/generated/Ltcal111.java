...
public class Ltcal111 extends CobolProgram {
    private int tally = 0;
    ...
    private void h_pr_ipps_pmt_pct() {
        if (Integer.parseInt(String.valueOf(h_ipps_wage_index).trim()) > 1) {
            h_ipps_nat_labor_shr.set(String.valueOf(3552.91));
            h_ipps_nat_nonlabor_shr.set(String.valueOf(1611.2));
        } else {
            h_ipps_nat_labor_shr.set(String.valueOf(3201.75));
            h_ipps_nat_nonlabor_shr.set(String.valueOf(1962.36));
        }
        if (w_ipps_pr_wage_index.compareTo(new BigDecimal(String.valueOf(1).trim())) > 0) {
            h_ipps_pr_labor_shr.set(String.valueOf(1518.14));
            h_ipps_pr_nonlabor_shr.set(String.valueOf(926.53));
        } else {
            h_ipps_pr_labor_shr.set(String.valueOf(1515.7));
            h_ipps_pr_nonlabor_shr.set(String.valueOf(928.97));
        }
        /* RAW: 0100 - */
        return;
    }
