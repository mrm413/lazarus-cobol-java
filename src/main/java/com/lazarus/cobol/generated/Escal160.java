...
public class Escal160 extends CobolProgram {
    private int tally = 0;
    ...
    private void calculate_bundled_factors() {
        ...
        if (h_patient_age > 17) {
            h_bun_bsa_factor = new BigDecimal(String.valueOf(Math.pow(cm_bsa, ((((h_bun_bsa - 1.9)) / 0.1)))).trim()).intValue();
        } else {
    ...
    private void calc_outlier_factors_2() {
        ...
        if (h_patient_age > 17) {
            h_out_bsa_factor = new BigDecimal(String.valueOf(Math.pow(sb_bsa, ((((h_out_bsa - 1.9)) / 0.1)))).trim()).intValue();
        } else {
