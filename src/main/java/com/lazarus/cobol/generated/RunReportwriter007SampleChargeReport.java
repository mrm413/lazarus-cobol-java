...
public class RunReportwriter007SampleChargeReport extends CobolProgram {
    ...
    private CobolString filler_7 = new CobolString(47);
    private CobolString filler_8 = new CobolString(47);
    private CobolString filler_9 = new CobolString(47);
    ...
    private CobolString filler_10 = new CobolString(47);
    private CobolString tr_customer_name = new CobolString(16);
    private CobolString filler_11 = new CobolString(47);
    private int tr_item_number = 0;
    private int tr_item_department = 0;
    private CobolString filler_12 = new CobolString(47);
    private CobolString filler_13 = new CobolString(47);
    private int tr_item_cost = 0;
    private CobolString filler_14 = new CobolString(47);
