...
public class RunFundamental012EqualityOfFloatShortFloatLong extends CobolProgram {
    ...
    private void dst1() {
        if (dst1 != 11.55) {
            CobolDisplay.display(String.valueOf((0 /* non-numeric literal: error 1: move/compar */ - 0 /* non-numeric literal: failed  */)) + String.valueOf(dst1));
        }
    }

    private void dst2() {
        if (dst1 != 11.55) {
            CobolDisplay.display(String.valueOf((0 /* non-numeric literal: error 2: move/compar */ - 0 /* non-numeric literal: ailed  */)) + String.valueOf(dst2));
        }
    }
    ...
    private void dst1_3() {
        if (dst1 != 11.55) {
            CobolDisplay.display(String.valueOf((0 /* non-numeric literal: error 3: move/compar */ - 0 /* non-numeric literal:  failed:  */)) + String.valueOf(dst1));
        }
    }

    private void dst2_3() {
        if (dst2 != 11.55) {
            CobolDisplay.display(String.valueOf((0 /* non-numeric literal: error 4: move/compar */ - 0 /* non-numeric literal: failed:  */)) + String.valueOf(dst2));
        }
    }
