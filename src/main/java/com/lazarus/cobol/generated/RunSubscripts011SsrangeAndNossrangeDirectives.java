...
public class RunSubscripts011SsrangeAndNossrangeDirectives extends CobolProgram {
    private int tally = 0;
    ...
    private CobolString nossrange = new CobolString(256); // fallback
    private CobolString display = new CobolString(256); // fallback
    private CobolString ssrange = new CobolString(256); // fallback
    ...
    public static void main(String[] args) {
        new RunSubscripts011SsrangeAndNossrangeDirectives().run();
    }
}
