...
public class Linage extends CobolProgram {
    private int tally = 0;
    ...
    private CobolString indexing_ok = new CobolString(256);
    private CobolString no_more_duplicates = new CobolString(256);
    private CobolString cb_false = new CobolString(256);
    private CobolString no_more_records = new CobolString(256);
