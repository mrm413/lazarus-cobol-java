...
public class Escal151 extends CobolProgram {
    private int tally = 0;
    ...
    private CobolString valid_comorbid_cwf_return_cd = new CobolString(256); // fallback
    ...
    private void validate_bill_elements_2() {
        ...
        if (String.valueOf(pps_rtc).equals(String.valueOf(0))) {
            if ((String.valueOf(comorbid_cwf_return_code).equals(String.valueOf(" ")) || !String.valueOf(valid_comorbid_cwf_return_cd).trim().isEmpty())) {
                /* NEXT SENTENCE */
            } else {
        ...
        if (String.valueOf(comorbid_cwf_return_code).equals(String.valueOf(" "))) {
            ...
            if (String.valueOf(comorbid_cwf_return_code).equals(String.valueOf("10"))) {
                ...
                if (String.valueOf(comorbid_cwf_return_code).equals(String.valueOf("20"))) {
                    ...
                    if (String.valueOf(comorbid_cwf_return_code).equals(String.valueOf("30"))) {
                        if (comorbid_data[1 - 1] == null) comorbid_data[1 - 1] = new CobolString(256);
                        comorbid_data[1 - 1].set(String.valueOf(" "));
                        if (comorbid_data[2 - 1] == null) comorbid_data[2 - 1] = new CobolString(256);
                        comorbid_data[2 - 1].set(String.valueOf("MB"));
                        if (comorbid_data[3 - 1] == null) comorbid_data[3 - 1] = new CobolString(256);
                        comorbid_data[3 - 1].set(String.valueOf(" "));
                        if (comorbid_data[4 - 1] == null) comorbid_data[4 - 1] = new CobolString(256);
                        comorbid_data[4 - 1].set(String.valueOf(" "));
                        ...
                        if (String.valueOf(comorbid_cwf_return_code).equals(String.valueOf("40"))) {
                            ...
                            if (String.valueOf(comorbid_cwf_return_code).equals(String.valueOf("50"))) {
                                ...
                                if (String.valueOf(comorbid_cwf_return_code).equals(String.valueOf("60"))) {
                                    ...
                                    comorbid_cwf_return_code.set(String.valueOf(" "));
                                    if (comorbid_data[6 - 1] == null) comorbid_data[6 - 1] = new CobolString(256);
                                    comorbid_data[6 - 1].set(String.valueOf("MF"));
                                }
                            }
                        }
                    }
    ...
    private void calculate_bundled_factors() {
        ...
        if (h_patient_age > 17) {
            h_bun_bsa_factor = new BigDecimal(String.valueOf(Math.pow(cm_bsa, ((((h_bun_bsa - 1.87)) / 0.1)))).trim()).intValue();
        } else {
        ...
        if (String.valueOf(comorbid_cwf_return_code).equals(String.valueOf(" "))) {
            ...
            if (String.valueOf(comorbid_cwf_return_code).equals(String.valueOf("10"))) {
                ...
                if (String.valueOf(comorbid_cwf_return_code).equals(String.valueOf("20"))) {
                    ...
                    if (String.valueOf(comorbid_cwf_return_code).equals(String.valueOf("30"))) {
                        h_bun_comorbid_multiplier = new BigDecimal(String.valueOf(cm_pneumonia).trim()).intValue();
                        pps_2011_comorbid_pay.set(String.valueOf("30"));
                    } else {
                        if (String.valueOf(comorbid_cwf_return_code).equals(String.valueOf("40"))) {
        ...
        h_bun_adjusted_base_wage_amt = new BigDecimal(String.valueOf((((((h_bun_base_wage_amt * h_bun_age_factor)) * ((h_bun_bsa_factor * h_bun_bmi_factor))) * ((h_bun_onset_factor * h_bun_comorbid_multiplier))) * (h_bun_low_vol_multiplier))).trim()).intValue();
        if (String.valueOf(b_cond_code).equals(String.valueOf("73"))) {
            if (h_bun_onset_factor == cm_onset_le_120) {
            ...
            if ((String.valueOf(b_cond_code).equals(String.valueOf("74")) && (String.valueOf(b_rev_code).equals(String.valueOf("0841")) || true))) {
                h_cc_74_per_diem_amt = new BigDecimal(String.valueOf((((h_bun_adjusted_base_wage_amt * 3)) / 7)).trim()).intValue();
            } else {
                h_bun_wage_adj_training_amt = new BigDecimal(String.valueOf(0).trim()).intValue();
        ...
        if ((String.valueOf(b_cond_code).equals(String.valueOf("74")) && (String.valueOf(b_rev_code).equals(String.valueOf("0841")) || true))) {
            h_pps_final_pay_amt = new BigDecimal(String.valueOf(h_cc_74_per_diem_amt).trim()).intValue();
    // h_full_claim_amt = new BigDecimal(String.valueOf((((h_bun_adjusted_base_wage_amt * (((b_claim_num_dialysis_sessions) * 3))) / 7))).trim()).intValue();
            ...
            h_pps_final_pay_amt = new BigDecimal(String.valueOf((h_bun_adjusted_base_wage_amt + h_bun_wage_adj_training_amt)).trim()).intValue();
        }
        _2500();
        /* RAW: -  */
    }
    ...
    private void pps_2011_comorbid_pay() {
        for (sub = 1; !((sub > 6 || !String.valueOf(high_comorbid_found).trim().isEmpty())); sub += 1) {
            if (String.valueOf(comorbid_data[sub - 1]).equals(String.valueOf("MA"))) {
                ...
                is_high_comorbid_found.set(String.valueOf("Y"));
                acute_comorbid_track.set(String.valueOf("Y"));
                pps_2011_comorbid_pay.set(String.valueOf("20"));
            } else {
                if (String.valueOf(comorbid_data[sub - 1]).equals(String.valueOf("MB"))) {
                    if (cm_pneumonia > h_comorbid_multiplier) {
                        h_comorbid_multiplier = new BigDecimal(String.valueOf(cm_pneumonia).trim()).intValue();
                        acute_comorbid_track.set(String.valueOf("Y"));
                        pps_2011_comorbid_pay.set(String.valueOf("30"));
                    }
                } else {
                    if (String.valueOf(comorbid_data[sub - 1]).equals(String.valueOf("MC"))) {
                        ...
                        if (String.valueOf(comorbid_data[sub - 1]).equals(String.valueOf("MD"))) {
                            ...
                            if (String.valueOf(comorbid_data[sub - 1]).equals(String.valueOf("ME"))) {
                                ...
                                if (String.valueOf(comorbid_data[sub - 1]).equals(String.valueOf("MF"))) {
                                    if (cm_monoclonal_gamm > h_comorbid_multiplier) {
                                        h_comorbid_multiplier = new BigDecimal(String.valueOf(cm_monoclonal_gamm).trim()).intValue();
                                        chronic_comorbid_track.set(String.valueOf("Y"));
                                        pps_2011_comorbid_pay.set(String.valueOf("70"));
                                    }
                                }
                            }
                        }
    ...
    private void calc_outlier_factors_2() {
        ...
        if (h_patient_age > 17) {
            h_out_bsa_factor = new BigDecimal(String.valueOf(Math.pow(sb_bsa, ((((h_out_bsa - 1.87)) / 0.1)))).trim()).intValue();
        } else {
        ...
        if (String.valueOf(comorbid_cwf_return_code).equals(String.valueOf(" "))) {
            ...
            if (String.valueOf(comorbid_cwf_return_code).equals(String.valueOf("10"))) {
                ...
                if (String.valueOf(comorbid_cwf_return_code).equals(String.valueOf("20"))) {
                    ...
                    if (String.valueOf(comorbid_cwf_return_code).equals(String.valueOf("30"))) {
                        h_out_comorbid_multiplier = new BigDecimal(String.valueOf(sb_pneumonia).trim()).intValue();
                    } else {
                        if (String.valueOf(comorbid_cwf_return_code).equals(String.valueOf("40"))) {
        ...
        h_out_predicted_services_map = new BigDecimal(String.valueOf(((((((h_out_age_factor * h_out_bsa_factor) * h_out_bmi_factor) * h_out_onset_factor) * h_out_comorbid_multiplier) * h_out_low_vol_multiplier))).trim()).intValue();
        if (h_patient_age < 18) {
    ...
    private void h_out_comorbid_multiplier() {
        for (sub = 1; !((sub > 6 || !String.valueOf(high_comorbid_found).trim().isEmpty())); sub += 1) {
            if (String.valueOf(comorbid_data[sub - 1]).equals(String.valueOf("MA"))) {
                ...
                if (String.valueOf(comorbid_data[sub - 1]).equals(String.valueOf("MB"))) {
                    if (sb_pneumonia > h_out_comorbid_multiplier) {
                        h_out_comorbid_multiplier = new BigDecimal(String.valueOf(sb_pneumonia).trim()).intValue();
                        acute_comorbid_track.set(String.valueOf("Y"));
                    }
                } else {
                    if (String.valueOf(comorbid_data[sub - 1]).equals(String.valueOf("MC"))) {
                        ...
                        if (String.valueOf(comorbid_data[sub - 1]).equals(String.valueOf("MD"))) {
                            ...
                            if (String.valueOf(comorbid_data[sub - 1]).equals(String.valueOf("ME"))) {
                                ...
                                if (String.valueOf(comorbid_data[sub - 1]).equals(String.valueOf("MF"))) {
                                    if (sb_monoclonal_gamm > h_out_comorbid_multiplier) {
                                        h_out_comorbid_multiplier = new BigDecimal(String.valueOf(sb_monoclonal_gamm).trim()).intValue();
                                        chronic_comorbid_track.set(String.valueOf("Y"));
                                    }
                                }
                            }
    ...
    private void low_vol_full_pps_payment() {
        h_lv_bun_adjust_base_wage_amt = new BigDecimal(String.valueOf(((((h_bun_base_wage_amt * h_bun_age_factor)) * ((h_bun_bsa_factor * h_bun_bmi_factor))) * ((h_bun_onset_factor * h_bun_comorbid_multiplier)))).trim()).intValue();
        if (String.valueOf(b_cond_code).equals(String.valueOf("73"))) {
            if (h_bun_onset_factor == cm_onset_le_120) {
                h_bun_wage_adj_training_amt = new BigDecimal(String.valueOf(0).trim()).intValue();
            } else {
    ...
    private void low_vol_out_pps_payment() {
        h_lv_out_predict_services_map = new BigDecimal(String.valueOf((((((h_out_age_factor * h_out_bsa_factor) * h_out_bmi_factor) * h_out_onset_factor) * h_out_comorbid_multiplier))).trim()).intValue();
        if (h_patient_age < 18) {
    ...
    private void calc_comp_rate_factors() {
        if (h_patient_age < 18) {
            h_age_factor = new BigDecimal(String.valueOf(cr_age_lt_18).trim()).intValue();
        } else {
            if (h_patient_age < 45) {
                h_age_factor = new BigDecimal(String.valueOf(cr_age_18_44).trim()).intValue();
            } else {
                if (h_patient_age < 60) {
                    h_age_factor = new BigDecimal(String.valueOf(cr_age_45_59).trim()).intValue();
                } else {
                    if (h_patient_age < 70) {
                        h_age_factor = new BigDecimal(String.valueOf(cr_age_60_69).trim()).intValue();
                    } else {
                        if (h_patient_age < 80) {
                            h_age_factor = new BigDecimal(String.valueOf(cr_age_70_79).trim()).intValue();
                        } else {
                            h_age_factor = new BigDecimal(String.valueOf(cr_age_80_plus).trim()).intValue();
                        }
                    }
                }
            }
        ...
        if (h_patient_age > 17) {
            h_bsa_factor = new BigDecimal(String.valueOf(Math.pow(cr_bsa, ((((h_bsa - 1.87)) / 0.1)))).trim()).intValue();
        } else {
        ...
        if ((h_patient_age > 17 && h_bmi < 18.5)) {
            h_bmi_factor = new BigDecimal(String.valueOf(cr_bmi_lt_18_5).trim()).intValue();
        } else {
            h_bmi_factor = new BigDecimal(String.valueOf(1).trim()).intValue();
        }
        if (String.valueOf(p_esrd_rate).equals(String.valueOf(0))) {
            h_payment_rate = new BigDecimal(String.valueOf(base_payment_rate).trim()).intValue();
        } else {
            h_payment_rate = new BigDecimal(String.valueOf(p_esrd_rate).trim()).intValue();
        }
        h_wage_adj_pymt_amt = new BigDecimal(String.valueOf((((((((h_payment_rate * nat_labor_pct)) * Integer.parseInt(String.valueOf(com_cbsa_w_index).trim()))) + ((h_payment_rate * nat_nonlabor_pct)))) * cbsa_blend_pct)).trim()).intValue();
        h_pymt_amt = new BigDecimal(String.valueOf(((((((h_wage_adj_pymt_amt * h_bmi_factor) * h_bsa_factor) * case_mix_bdgt_neut_factor) * h_age_factor) * drug_addon))).trim()).intValue();
    }
    ...
    private void pps_2011_full_outlier_rate() {
        if (String.valueOf(p_qip_reduction).equals(String.valueOf(" "))) {
            ...
            pps_2011_full_pps_rate.set(String.valueOf((Integer.parseInt(String.valueOf(pps_2011_full_pps_rate).trim()) * qip_reduction)));
