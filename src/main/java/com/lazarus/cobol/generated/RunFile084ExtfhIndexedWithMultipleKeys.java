...
public class RunFile084ExtfhIndexedWithMultipleKeys extends CobolProgram {
    ...
    private CobolString fcd_area = new CobolString(256);
    private CobolString fcd_version_number = new CobolString(256);
    private CobolString fcd_version = new CobolString(256);
    private CobolString _unnamed = new CobolString(256);
    private CobolString make = new CobolString(256);
    private CobolString _3 = new CobolString(256);
    private CobolString keys = new CobolString(256);
    private CobolString mf = new CobolString(256);
    private CobolString key_def = new CobolString(256);
    private CobolString key_def_area = new CobolString(256);
    ...
    private CobolString fixed = new CobolString(256);
    private CobolString or = new CobolString(256);
    private CobolString variable = new CobolString(256);
    ...
    private CobolString data_area2 = new CobolString(256);
    ...
    private CobolString rewrite_record = new CobolString(256);
    ...
    private void a_100_open_file() {
        ...
        _unnamed.set(String.valueOf(fcd_version_number));
    ...
    private void fcd_key_length() {
    }

    private void prime_key_2() {
