...
public class Ltcal162 extends CobolProgram {
    private int tally = 0;
    ...
    private CobolString h_nat_oper_ipps_pmt_pct = new CobolString(256); // fallback
    private CobolString h_pr_oper_ipps_pmt_pct = new CobolString(256); // fallback
    private CobolString h_nat_capi_ipps_pmt_pct = new CobolString(256); // fallback
    private CobolString h_pr_capi_ipps_pmt_pct = new CobolString(256); // fallback
    ...
    private void pps_nat_nonlabor_pct() {
        if (String.valueOf(p_new_hosp_qual_ind).equals(String.valueOf("1"))) {
            pps_std_fed_rate = new BigDecimal(String.valueOf(41762.85).trim()).intValue();
        } else {
    ...
    private void h_fixed_loss_amt_std() {
        if (Integer.parseInt(String.valueOf(b_discharge_date).trim()) < 20160101) {
            h_fixed_loss_amt_snt.set(String.valueOf(22539));
        } else {
            h_fixed_loss_amt_snt.set(String.valueOf(22538));
        }
    }

    private void pps_bdgt_neut_rate() {
        if (Integer.parseInt(String.valueOf(b_discharge_date).trim()) < 20160101) {
            h_ipps_capi_std_fed_rate.set(String.valueOf(438.75));
            h_ipps_capi_std_pr_rate.set(String.valueOf(212.55));
        } else {
            h_ipps_capi_std_fed_rate.set(String.valueOf(438.75));
            h_ipps_capi_std_pr_rate.set(String.valueOf(212.29));
        }
        if (Integer.parseInt(String.valueOf(b_discharge_date).trim()) < 20160101) {
            h_nat_oper_ipps_pmt_pct.set(String.valueOf(0.75));
            h_pr_oper_ipps_pmt_pct.set(String.valueOf(0.25));
            h_nat_capi_ipps_pmt_pct.set(String.valueOf(0.75));
            h_pr_capi_ipps_pmt_pct.set(String.valueOf(0.25));
        } else {
            h_nat_oper_ipps_pmt_pct.set(String.valueOf(1));
            h_pr_oper_ipps_pmt_pct.set(String.valueOf(0));
            h_nat_capi_ipps_pmt_pct.set(String.valueOf(0.75));
            h_pr_capi_ipps_pmt_pct.set(String.valueOf(0.25));
        }
    }
    ...
    private void h_ipps_wage_index() {
        if (Integer.parseInt(String.valueOf(h_ipps_wage_index).trim()) > 1) {
            if (Integer.parseInt(String.valueOf(b_discharge_date).trim()) < 20160101) {
                h_ipps_nat_labor_shr.set(String.valueOf(3805.3));
                h_ipps_nat_nonlabor_shr.set(String.valueOf(1662.09));
            } else {
                h_ipps_nat_labor_shr.set(String.valueOf(3805.4));
                h_ipps_nat_nonlabor_shr.set(String.valueOf(1662.13));
            }
        } else {
            if (Integer.parseInt(String.valueOf(b_discharge_date).trim()) < 20160101) {
                h_ipps_nat_labor_shr.set(String.valueOf(3389.78));
                h_ipps_nat_nonlabor_shr.set(String.valueOf(2077.61));
            } else {
                h_ipps_nat_labor_shr.set(String.valueOf(3389.87));
                h_ipps_nat_nonlabor_shr.set(String.valueOf(2077.66));
            }
        }
        if (w_ipps_pr_wage_index.compareTo(new BigDecimal(String.valueOf(1).trim())) > 0) {
            if (Integer.parseInt(String.valueOf(b_discharge_date).trim()) < 20160101) {
                h_ipps_pr_labor_shr.set(String.valueOf(1650));
                h_ipps_pr_nonlabor_shr.set(String.valueOf(960.77));
            }
        } else {
            if (Integer.parseInt(String.valueOf(b_discharge_date).trim()) < 20160101) {
                h_ipps_pr_labor_shr.set(String.valueOf(1618.68));
                h_ipps_pr_nonlabor_shr.set(String.valueOf(992.09));
            }
        }
    }
    ...
    // h_pr_stand_amt_oper_pmt.set(String.valueOf((((((new BigDecimal(String.valueOf(h_ipps_pr_labor_shr).trim()).multiply(w_ipps_pr_wage_index)) + ((Integer.parseInt(String.valueOf(h_ipps_pr_nonlabor_shr).trim()) * Integer.parseInt(String.valueOf(h_oper_cola).trim()))))) * Integer.parseInt(String.valueOf(h_ipps_drg_wgt).trim())) * (((1 + Integer.parseInt(String.valueOf(h_oper_ime_teach).trim())) + Integer.parseInt(String.valueOf(h_oper_dsh).trim()))))));
        ...
        h_ipps_pay_amt.set(String.valueOf((((((Integer.parseInt(String.valueOf(h_stand_amt_oper_pmt).trim()) * Integer.parseInt(String.valueOf(h_nat_oper_ipps_pmt_pct).trim()))) + ((Integer.parseInt(String.valueOf(h_capi_pmt).trim()) * Integer.parseInt(String.valueOf(h_nat_capi_ipps_pmt_pct).trim()))))) + ((((Integer.parseInt(String.valueOf(h_pr_stand_amt_oper_pmt).trim()) * Integer.parseInt(String.valueOf(h_pr_oper_ipps_pmt_pct).trim()))) + ((Integer.parseInt(String.valueOf(h_pr_capi_pmt).trim()) * Integer.parseInt(String.valueOf(h_pr_capi_ipps_pmt_pct).trim()))))))));
        h_ipps_per_diem.set(String.valueOf((((Integer.parseInt(String.valueOf(h_ipps_pay_amt).trim()) / Integer.parseInt(String.valueOf(h_ipps_drg_alos).trim()))) * Integer.parseInt(String.valueOf(h_los).trim()))));
        if (String.valueOf(h_ipps_per_diem).compareTo(String.valueOf(h_ipps_pay_amt)) > 0) {
            h_ipps_per_diem.set(String.valueOf(h_ipps_pay_amt));
        }
    ...
    private void calc_high_cost_outlier() {
        ...
        if ((!(!String.valueOf(pmt_blend).trim().isEmpty()) && !((!String.valueOf(pmt_site_neutral).trim().isEmpty() && !String.valueOf(pmt_site_neut_cost).trim().isEmpty())))) {
            if (pps_fac_costs > pps_outlier_threshold) {
                ...
                if ((!String.valueOf(pmt_site_neutral).trim().isEmpty() && !String.valueOf(pmt_site_neut_ipps).trim().isEmpty())) {
                    pps_outlier_pay_amt = new BigDecimal(String.valueOf((pps_outlier_pay_amt * Integer.parseInt(String.valueOf(h_bdgt_neut_factor).trim()))).trim()).intValue();
                }
            }
        }
        if (!String.valueOf(pmt_blend).trim().isEmpty()) {
            ...
            if ((!String.valueOf(pmt_site_neut_ipps).trim().isEmpty() && pps_fac_costs > pps_outlier_threshold)) {
                h_outlier_pay_amt_snt.set(String.valueOf((((((((pps_fac_costs - pps_outlier_threshold)) * 0.8)) * Integer.parseInt(String.valueOf(h_blend_snt).trim()))) * Integer.parseInt(String.valueOf(h_bdgt_neut_factor).trim()))));
            }
