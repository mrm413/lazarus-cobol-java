...
public class RunManualScreen007DisplayLowValuesOneStatement extends CobolProgram {
    private int tally = 0;
    ...
    private void para_main() {
        ...
        CobolDisplay.display("\u0000" + String.valueOf(at) + String.valueOf(line) + String.valueOf(3) + String.valueOf(_filler_002) + String.valueOf(col) + String.valueOf(3) + "Hello!");
    ...
    public static void main(String[] args) {
        new RunManualScreen007DisplayLowValuesOneStatement().run();
    }
}
