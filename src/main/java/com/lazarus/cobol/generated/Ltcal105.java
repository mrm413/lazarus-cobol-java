...
public class Ltcal105 extends CobolProgram {
    private int tally = 0;
    ...
    private void h_pr_ipps_pmt_pct() {
        if (Integer.parseInt(String.valueOf(h_ipps_wage_index).trim()) > 1) {
            h_ipps_nat_labor_shr.set(String.valueOf(3587.24));
            h_ipps_nat_nonlabor_shr.set(String.valueOf(1626.78));
        } else {
            h_ipps_nat_labor_shr.set(String.valueOf(3232.69));
            h_ipps_nat_nonlabor_shr.set(String.valueOf(1981.33));
        }
        if (w_ipps_pr_wage_index.compareTo(new BigDecimal(String.valueOf(1).trim())) > 0) {
            h_ipps_pr_labor_shr.set(String.valueOf(1543.61));
            h_ipps_pr_nonlabor_shr.set(String.valueOf(942.07));
        } else {
            h_ipps_pr_labor_shr.set(String.valueOf(1541.12));
            h_ipps_pr_nonlabor_shr.set(String.valueOf(944.56));
        }
        /* RAW: 0100 - */
        return;
    }
