...
public class Ltcal094 extends CobolProgram {
    private int tally = 0;
    ...
    private void h_pr_ipps_pmt_pct() {
        if (Integer.parseInt(String.valueOf(h_ipps_wage_index).trim()) > 1) {
            h_ipps_nat_labor_shr.set(String.valueOf(3574.5));
            h_ipps_nat_nonlabor_shr.set(String.valueOf(1553.91));
        } else {
            h_ipps_nat_labor_shr.set(String.valueOf(3179.61));
            h_ipps_nat_nonlabor_shr.set(String.valueOf(1948.8));
        }
        if (w_ipps_pr_wage_index.compareTo(new BigDecimal(String.valueOf(1).trim())) > 0) {
            h_ipps_pr_labor_shr.set(String.valueOf(1507.82));
            h_ipps_pr_nonlabor_shr.set(String.valueOf(924.15));
        } else {
            h_ipps_pr_labor_shr.set(String.valueOf(1427.57));
            h_ipps_pr_nonlabor_shr.set(String.valueOf(1004.4));
        }
        /* RAW: 0100 - */
        return;
    }
