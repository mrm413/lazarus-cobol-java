...
public class RunExtensions070SystemRoutineCblGcFork extends CobolProgram {
    private int tally = 0;
    ...
    private int parent_pid = 0;



    private void para_main() {
        CobolProgram.call("C$GETPID");
    ...
    private void parent_code() {
        ...
        CobolProgram.call("C$SLEEP", 4);
        CobolDisplay.display("Parent again");
        if (return_code == parent_pid) {
            CobolDisplay.display("PARENT: parent and child have same PID: " + "'" + String.valueOf(parent_pid) + "'");
        }
        CobolProgram.call("C$GETPID");
        if (return_code != parent_pid) {
    ...
    public static void main(String[] args) {
        new RunExtensions070SystemRoutineCblGcFork().run();
    }
}
