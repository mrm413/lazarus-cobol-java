...
public class SynMisc096ConstantExpressions2 extends CobolProgram {
    ...
    private CobolString othervar = new CobolString(256);
    private CobolString _unnamed = new CobolString(256);
    private CobolString cb_var = new CobolString(256);
    ...
    private void para_main() {
        ...
        } else if (String.valueOf(const1).equals(String.valueOf(_unnamed))) {
            /* RAW: 16  */
