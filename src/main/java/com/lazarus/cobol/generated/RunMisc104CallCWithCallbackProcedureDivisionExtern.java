...
public class RunMisc104CallCWithCallbackProcedureDivisionExtern extends CobolProgram {
    private int tally = 0;
    ...
    public static void main(String[] args) {
        new RunMisc104CallCWithCallbackProcedureDivisionExtern().run();
    }
}
