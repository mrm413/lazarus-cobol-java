...
public class ProgCrt4 extends CobolProgram {
    private int tally = 0;
    ...
    private void para_main() {
        ...
        while (true) {
            ...
            for (loop = 1; !(loop > 7); loop += 1) {
                ...
                CobolDisplay.display(String.valueOf(crt4) + String.valueOf(line) + String.valueOf(linenr) + String.valueOf(_unnamed) + String.valueOf(column) + String.valueOf(30));
