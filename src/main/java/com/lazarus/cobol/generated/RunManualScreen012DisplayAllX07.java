...
public class RunManualScreen012DisplayAllX07 extends CobolProgram {
    private int tally = 0;
    ...
    public static void main(String[] args) {
        new RunManualScreen012DisplayAllX07().run();
    }
}
