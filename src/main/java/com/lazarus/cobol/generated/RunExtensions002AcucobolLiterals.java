...
public class RunExtensions002AcucobolLiterals extends CobolProgram {
    ...
    private void para_main() {
        ...
        CobolDisplay.display(String.valueOf(o) + String.valueOf(17777777777L));
        CobolDisplay.display(String.valueOf(x) + String.valueOf(ffffffff));
        CobolDisplay.display(String.valueOf(h) + String.valueOf(ffffffff));
        System.exit(0);
    }
