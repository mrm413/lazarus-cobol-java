...
public class RunFile081ExtfhFixedSequential extends CobolProgram {
    ...
    private CobolString fcd_sequential_org = new CobolString(256); // fallback
    ...
    private CobolString fix_filename = new CobolString(256); // fallback
    ...
    private CobolString fix_recordarea = new CobolString(256); // fallback
    ...
    private CobolString fix_tx = new CobolString(256); // fallback
    private CobolString fix_tcount = new CobolString(256); // fallback
    private CobolString extfh_opcode_iswrite = new CobolString(256); // fallback
    private CobolString[] fix_test_len = new CobolString[100]; // fallback array
