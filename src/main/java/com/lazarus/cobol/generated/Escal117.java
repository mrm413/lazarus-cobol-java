...
public class Escal117 extends CobolProgram {
    private int tally = 0;
    ...
    private void calc_comp_rate_factors() {
        ...
        if (h_patient_age > 17) {
            h_bsa_factor = new BigDecimal(String.valueOf(Math.pow(cr_bsa, ((((h_bsa - 1.84)) / 0.1)))).trim()).intValue();
        } else {
        ...
        h_pymt_amt = new BigDecimal(String.valueOf((((((((h_wage_adj_pymt_amt * h_bmi_factor) * h_bsa_factor) * case_mix_bdgt_neut_factor) * h_age_factor) * drug_addon)) + a_49_cent_part_d_drug_adj)).trim()).intValue();
    }
