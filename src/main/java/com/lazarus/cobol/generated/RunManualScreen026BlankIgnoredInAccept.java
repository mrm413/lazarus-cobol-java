...
public class RunManualScreen026BlankIgnoredInAccept extends CobolProgram {
    private int tally = 0;
    ...
    private void para_main() {
        ...
        success_scr.set(String.valueOf(CobolDisplay.accept()));
    ...
    public static void main(String[] args) {
        new RunManualScreen026BlankIgnoredInAccept().run();
    }
}
