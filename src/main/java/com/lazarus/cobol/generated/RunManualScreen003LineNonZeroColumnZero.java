...
public class RunManualScreen003LineNonZeroColumnZero extends CobolProgram {
    private int tally = 0;
    ...
    private void para_main() {
        ...
        CobolDisplay.display("2" + String.valueOf(line) + String.valueOf(2) + String.valueOf(_filler_002) + String.valueOf(column) + String.valueOf(0) + "3");
    ...
    public static void main(String[] args) {
        new RunManualScreen003LineNonZeroColumnZero().run();
    }
}
