...
public class RunManualScreen021FieldBackgroundForegroundColourViaControl extends CobolProgram {
    ...
    private void testme() {
        ...
        _unnamed.set(String.valueOf("REVERSE,"));
        ...
        _unnamed.set(String.valueOf("HIGHLIGHT,NO REVERSE"));
        ...
        _unnamed.set(String.valueOf("NO HIGH, BLINK"));
    ...
    private void dspcol() {
        CobolDisplay.display(String.valueOf(scrblack) + String.valueOf(line) + String.valueOf(lin) + String.valueOf(col) + String.valueOf(1) + String.valueOf(_unnamed) + String.valueOf(control));
    }

    private void cblack() {
        CobolDisplay.display(String.valueOf(scrblue) + String.valueOf(line) + String.valueOf(lin) + String.valueOf(col) + String.valueOf(10) + String.valueOf(_unnamed) + String.valueOf(control));
    }

    private void cblue() {
        CobolDisplay.display(String.valueOf(scrgreen) + String.valueOf(line) + String.valueOf(lin) + String.valueOf(col) + String.valueOf(19) + String.valueOf(_unnamed) + String.valueOf(control));
    }

    private void cgreen() {
        CobolDisplay.display(String.valueOf(scrcyan) + String.valueOf(line) + String.valueOf(lin) + String.valueOf(col) + String.valueOf(28) + String.valueOf(_unnamed) + String.valueOf(control));
    }

    private void ccyan() {
        CobolDisplay.display(String.valueOf(scrred) + String.valueOf(line) + String.valueOf(lin) + String.valueOf(col) + String.valueOf(37) + String.valueOf(_unnamed) + String.valueOf(control));
    }

    private void cred() {
        CobolDisplay.display(String.valueOf(scrmaggy) + String.valueOf(line) + String.valueOf(lin) + String.valueOf(col) + String.valueOf(46) + String.valueOf(_unnamed) + String.valueOf(control));
    }

    private void cmagenta() {
        CobolDisplay.display(String.valueOf(scryell) + String.valueOf(line) + String.valueOf(lin) + String.valueOf(col) + String.valueOf(55) + String.valueOf(_unnamed) + String.valueOf(control));
    }

    private void cyellow() {
        CobolDisplay.display(String.valueOf(scrwhite) + String.valueOf(line) + String.valueOf(lin) + String.valueOf(col) + String.valueOf(70) + String.valueOf(_unnamed) + String.valueOf(control));
    }
