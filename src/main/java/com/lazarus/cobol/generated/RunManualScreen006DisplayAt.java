...
public class RunManualScreen006DisplayAt extends CobolProgram {
    private int tally = 0;
    ...
    private void para_main() {
        ...
        CobolDisplay.display("2" + String.valueOf(at) + String.valueOf(3003));
        CobolDisplay.display("3" + String.valueOf(at) + String.valueOf(screen_loc));
    ...
    public static void main(String[] args) {
        new RunManualScreen006DisplayAt().run();
    }
}
