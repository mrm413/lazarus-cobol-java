...
public class Ltcal123 extends CobolProgram {
    private int tally = 0;
    ...
    private void h_pr_ipps_pmt_pct() {
        if (Integer.parseInt(String.valueOf(h_ipps_wage_index).trim()) > 1) {
            h_ipps_nat_labor_shr.set(String.valueOf(3584.3));
            h_ipps_nat_nonlabor_shr.set(String.valueOf(1625.44));
        } else {
            h_ipps_nat_labor_shr.set(String.valueOf(3230.04));
            h_ipps_nat_nonlabor_shr.set(String.valueOf(1979.7));
        }
        if (w_ipps_pr_wage_index.compareTo(new BigDecimal(String.valueOf(1).trim())) > 0) {
            h_ipps_pr_labor_shr.set(String.valueOf(1553.29));
            h_ipps_pr_nonlabor_shr.set(String.valueOf(947.98));
        } else {
            h_ipps_pr_labor_shr.set(String.valueOf(1550.79));
            h_ipps_pr_nonlabor_shr.set(String.valueOf(950.48));
        }
        /* RAW: 0100 - */
        return;
    }
